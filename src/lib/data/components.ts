...
export const components: ComponentData = {
  ...
  gpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⭐ Newegg cheapest 1P May 25 NEW LOW: ZOTAC SOLID CORE OC $1,379 (DOWN $20 from May 17 GIGABYTE WindForce SFF $1,399 — first Newegg 1P floor break this month)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: '⭐ Amazon PNY ARGB EPIC-X $1,299 holds May 25 (13-day hold from May 11 per bestvaluegpu — cheapest authorized 1P; no $999 MSRP SKU since May 14)', url: 'https://www.amazon.com/s?k=rtx+5080' },
