...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Amazon ~$439 (May 23-27 reading, no fresh May 30 confirmation; 1P intermittently OOS, 3P fills in; Pangoly ATL was $409.95 April)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: '⚠️ Newegg-direct $459 list May 30 (QC WebFetch on PDP: UP $19 from $439.99 May 17-27 floor, no SSF6798 code visible on page, no free PSU bundle line; aggregators still claim code live but PDP doesn\'t corroborate — try at checkout). Cheapest Newegg path TODAY: PlatinumMicro 3P $439.99 (below Newegg-direct)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). Micro Center $599 in-store (clearing stock ahead of 9950X3D2 \u2014 unconfirmed if still current Apr 26). \u26A0\uFE0F Amazon ALL-TIME LOW $573.99 EXPIRED — reverted to $639.99 by May 14 (the $573.99 Apr 26-May 10 window has closed; CamelCamelCamel/Tom\'s HW; was live since Apr 26— Tom\'s HW May 9 still flags as topping Amazon best-sellers, 14 days continuous) (Amazon Gaming Week, 18% off $699 MSRP, $125 cut per Tom\'s HW + Windows Central + Club386 + VideoCardz; topped Amazon best-sellers list. Limited-time deal, stock flipped between in/OOS during window). ⚠ Newegg-direct LIFTED to $699 May 28 (QC WebFetch direct on PDP confirms; UP $84 from $614.99 May 25-27 floor; $25 code GONE post-Memorial Day; free Cooler Master Elite 240mm AIO STILL bundled). Memorial Day\'s "$639.99 - $25 code + free AIO = $614.99" PC Guide deal collapsed today alongside the 9800X3D SSF6798 reversion. ⚠️ MAY 30 UPDATE: $25 promo code GONE again — QC WebFetch on Newegg PDP today shows Newegg-direct $699 list (UP $59 from $639.99 May 29 with-code price, back to MSRP) but free Cooler Master Elite Liquid 240 AIO bundle STILL ACTIVE ("limited offer" language live on page; cooler not bundled — page explicitly says "Cooler not included" for the CPU but Newegg lists the AIO as a separate free add-on). The May 29 $614.99 net price did not survive Day 2 — collapsed back to MSRP. Amazon last confirmed $639.99 OOS (May 10), with 3P reports of $749.99 sitting above MSRP — Tom\'s HW late-May coverage notes 9950X3D briefly back in stock at MSRP for Memorial Day at "two retailers" but no fresh in-stock signal May 30. 3P alts $699-730 if needed sooner. Best Buy ~$699. ⚠️ Crimson Desert promo bundle ENDED Apr 25 — no longer a factor. \u26A0\uFE0F 9950X3D2 "Dual Edition" (208MB cache, dual V-Cache, 16c/32t, 4.3/5.6 GHz, 200W TDP) LAUNCHED APR 22 at $899 MSRP \u2014 TechSpot/Tom\'s HW/Phoronix/KitGuru reviews confirm only 0.8% gaming uplift over 9800X3D, 6-9% productivity gain (Blender +7%, LLVM +6.6%). Notebookcheck verdict: "questions its existence" for gamers. Both Amazon and Newegg now listing 9950X3D2 at $899 MSRP \u2014 no scalp premium post-launch (initial Amazon $999 preorder normalized). This pressures 9950X3D demand from above (better productivity) and below (9800X3D Amazon $409.95 NEW ATL May 11 matches it in gaming for $164 less even at the $574 Amazon floor).',
      advice: 'OVERKILL: Only 0.4-0.8% faster than 9800X3D in gaming for ~$240-300 more ($699 Newegg-direct MSRP May 30 + free CM Elite Liquid 240 AIO vs $399-$459 9800X3D depending on Micro Center / 3P / Newegg-direct path). No streaming planned, so the extra cores are wasted. ⚠️ MAY 30: $25 promo code COLLAPSED again — QC WebFetch on Newegg PDP shows $699 list (UP $59 from $639.99 May 29 with-code price), free Cooler Master Elite Liquid 240 AIO still bundled. The May 29 $614.99 net price did not survive Day 2 — short revert cycle, don\'t expect it back without a new holiday window. MC $599 in-store if available is still the cheapest absolute. \u26A0\uFE0F 9950X3D2 LAUNCHED Apr 22 at $899 MSRP and reviewers confirmed it adds only 0.8% over the 9800X3D in gaming \u2014 the whole high-end X3D stack just collapsed for pure gamers. The 9800X3D at ~$439 Amazon / $459 Newegg / $399 MC is the smarter buy (Memorial Day expirations widened the 9950X3D gap, not narrowed it). Only consider 9950X3D if you do heavy productivity (Blender, LLVM compile); don\'t pay $669-699 for a 0.4-0.8% gaming gain.',
      whyNot: 'Within 0.4-0.8% of 9800X3D in gaming (now confirmed by 9950X3D2 reviews — extra cache barely matters at 4K). No streaming = no use for 16 cores. At Newegg-direct MSRP $699 May 30 the $240-260 premium over 9800X3D ($439-$459 1P / 3P) buys nothing for your use case.',
      ...
      buyLinks: [
        ...
        { store: '⚠️ Amazon $639.99 last confirmed (May 10, OOS); 3P at $749.99 above MSRP per WCCFtech; Tom\'s HW reports brief Memorial Day MSRP restock at "two retailers" — no fresh May 30 in-stock signal', url: 'https://www.amazon.com/dp/B0DVZSG8D5' },
        { store: '⚠️ Newegg-direct $699 May 30 (QC WebFetch on PDP: UP $59 from $639.99 May 29 with-code price; $25 code COLLAPSED — May 29 $614.99 net did not survive Day 2). Free Cooler Master Elite Liquid 240 AIO bundle STILL ACTIVE on page', url: 'https://www.newegg.com/amd-ryzen-9-9000-series-ryzen-9-9950x3d-granite-ridge-socket-am5-desktop-cpu-processor/p/N82E16819113884' }
      ]
    }
  ],
  gpu: [
    ...
    },
    {
      ...
      perf4k: 90,
      tdp: 360,
      notes: '\u2B50\u2B50\u2B50 SWEET SPOT FOR 4K@160Hz - DLSS 4 MFG turns 68fps native into 238fps in Cyberpunk. \u2B50\u2B50\u2B50 $999 MSRP WINDOW HOLDS INTO DAY 4 May 30— multiple $999 MSRP cards still in stock per Tom\'s Hardware May 27-30 coverage: PNY GeForce RTX 5080 OC $999.99 Amazon, MSI Shadow 3X OC $999 Newegg, ZOTAC Solid Core RTX 5080 $999 Newegg (1P), PNY OC $999 Best Buy, ASUS Prime RTX 5080 SFF $999.99 (Amazon Prime members). This $999 window is now in its 4TH day — by far the LONGEST of the 3 May reopens (May 6 = 1 day, May 14 = <1 day, May 27-30 = 4 days and counting). ⭐⭐⭐ NEW MAY 30 HEADLINE: Walmart PNY RTX 5080 OC at $929 — LOWEST-EVER PRICE (Tom\'s HW: "the nvidia rtx 5080 drops to new lowest-ever price"). Walmart $929 actually signals inventory pressure easing, not tightening. Flash events historically last hours-to-days, not weeks; if ready to buy, grab one TODAY before SFF stock depletes. Above MSRP: ⭐⭐ Amazon ZOTAC SOLID CORE OC $1,249.99 holds May 30 (was $1,299 May 25 → $1,249.99 May 26-30, flat 5-day hold; PNY ARGB EPIC-X $1,299 still listed; per bestvaluegpu retail tracker average $1,249) and ⭐ Newegg 1P non-MSRP ZOTAC SOLID CORE OC $1,379 holds May 30. Walmart $929 PNY OC narrative dominates today. \u26a0\ufe0f Newegg 1P landscape May 27: $999 MSRP SFF SKUs at top (MSI Shadow 3X OC, ZOTAC Solid Core), then ZOTAC SOLID CORE OC $1,379, GIGABYTE WindForce SFF $1,399, mid-tier $1,376-1,499 (GIGABYTE WindForce OC SFF $1,376, GAMING OC $1,499, ASUS PRIME, MSI INSPIRE 3X OC BLACK $1,499.92). Windows Central + Tweaktown coverage confirms most non-SFF 5080 SKUs sit 30-50% above $999 MSRP. Micro Center ~$1,150-1,250 in-store (varies by model). Best Buy ~$1,260+. eBay used ~$1,150-1,200 (Tom\'s HW used tracker May 12 cites $1,189.89) — used is NOW PRICED ABOVE the $999 MSRP cards available today, warranty makes new the obvious call. \u26A0\uFE0F GDDR7 shortage + NVIDIA 30-40% production cuts, but 5080 is NVIDIA\'s PRIORITY 16GB card — better supply outlook than 5070 Ti. \u2B50 DLSS 5 announced at GTC 2026 (Fall 2026, RTX 50 exclusive) — neural rendering breakthrough, photoreal lighting via AI, massive future upgrade. DLSS 4.5 Dynamic MFG 6x live (596.21/596.36 WHQL drivers). 250+ MFG-compatible games. Prices peaked at $1,500 in Aug 2025.',
      advice: 'RECOMMENDED: Best realistic path to 160Hz@4K. ⭐⭐⭐ BUY TODAY: $999 MSRP WINDOW STILL OPEN May 30 (Day 4) — multiple cards in stock at MSRP per Tom\'s HW May 27-30 coverage: MSI Shadow 3X OC $999 Newegg (1P), ZOTAC Solid Core RTX 5080 $999 Newegg (1P), PNY OC $999 Best Buy. ⭐⭐⭐ NEW MAY 30 HEADLINE: Walmart PNY RTX 5080 OC at $929 — LOWEST-EVER PRICE (Tom\'s HW). The May 27-30 window has outlasted both the May 6 (1 day) and May 14 (<24h) reopens — by far the most durable $999 5080 window of the cycle, and Walmart now undercutting MSRP signals inventory pressure easing. BUY THE WALMART $929 PNY OC TODAY if Langley is ready; if it sells out, the $999 Newegg/Best Buy MSRP cards are right behind. Above MSRP: ⭐⭐ Amazon ZOTAC SOLID CORE OC $1,249.99 holds (was $1,299 → $1,249.99 May 26, flat May 27). ⭐ Newegg cheapest non-MSRP 1P: ZOTAC SOLID CORE OC $1,379 holds May 27. Mid-tier Newegg $1,376-1,499 (GIGABYTE WindForce OC SFF $1,376, GAMING OC $1,499, ASUS PRIME, MSI INSPIRE 3X OC BLACK $1,499.92). ⭐⭐⭐ STEP-UP MATH vs 5070 Ti at MSRP: $999 5080 vs $979 5070 Ti = $20 gap — at the MSRP windows the 5080 is a NO-BRAINER over the 5070 Ti for 15-18% more perf and reliable native 4K@160Hz. If MSRP window is closed when you check, $1,249.99 Amazon ZOTAC = $271 gap, still the right pick — the 5070 Ti averages ~54fps native and depends on DLSS 4 MFG to reach 160Hz, the 5080 averages ~68fps native and clears 160Hz with margin in most titles. ⭐ DLSS 5 coming Fall 2026 (RTX 50 exclusive, neural rendering) — locked to this card. NVIDIA prioritizing 5080 production. SUPER refresh indefinitely delayed (confirmed CES 2026) — TechPowerUp reports the entire Blackwell SUPER refresh may be CANCELLED due to 3GB GDDR7 module shortage. ⚠️ PRAGMATA bundle ENDED May 12 (codes redeemable on Steam through June 2 per NVIDIA terms; not a lever for May 13+ buys).',
      ...
      buyLinks: [
        { store: '⭐⭐⭐ Walmart PNY RTX 5080 OC $929 NEW LOWEST-EVER May 30 (Tom\'s HW: "drops to new lowest-ever price" — undercuts $999 MSRP)', url: 'https://www.walmart.com/search?q=pny+rtx+5080+oc' },
        { store: '⭐⭐⭐ $999 MSRP STILL OPEN Day 4 May 30 — MSI Shadow 3X OC $999 Newegg / ZOTAC Solid Core $999 Newegg / PNY OC $999 Best Buy. Outlasted May 6/14 windows by 3+ days', url: 'https://www.bestbuy.com/site/searchpage.jsp?st=pny+rtx+5080' },
        { store: '⭐⭐ Amazon ZOTAC SOLID CORE OC $1,249.99 holds May 30 (flat 5-day hold May 26-30; broader street avg $1,249 per bestvaluegpu; non-MSRP fallback)', url: 'https://www.amazon.com/s?k=rtx+5080' },
        { store: '⭐ Newegg non-MSRP 1P May 30: ZOTAC SOLID CORE OC $1,379 holds (above the MSRP-SFF tier)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Micro Center ~$2,910 (ASUS TUF OC, in-store, unverified May 30 — last week\'s baseline)', url: 'https://www.microcenter.com/search/search_results.aspx?Ntt=rtx+5090' },
        { store: '⭐ Newegg 5090 Founders Edition $3,695 May 30 (Tech4Gamers/WCCFtech/gamegpu.com TIER-1 reference; MSRP-tier 5090s OOS per nowinstock.net, FE is the 1P floor when listed). The May 29 ZOTAC SOLID OC $3,695 attribution was a misread — that PDP actually shows $5,299 from 3P "roboshine" Hong Kong', url: 'https://www.newegg.com/p/pl?d=rtx+5090' },
        { store: 'Newegg ASUS TUF: 3P only $4,199-5,099 (1P still GONE May 30 — 32 days since Apr 28)', url: 'https://www.newegg.com/asus-tuf-gaming-tuf-rtx5090-32g-gaming-geforce-rtx-5090-32gb-graphics-card-triple-fans/p/N82E16814126752' },
        { store: '⭐ Amazon ASUS ROG Astral OC $3,899.95 May 30 (Pangoly price history confirms current)', url: 'https://www.amazon.com/s?k=rtx+5090' },
        { store: 'B&H Photo $3,799.95 MSI Suprim Liquid SOC (last fully verified May 25, not freshly verified May 30)', url: 'https://www.bhphotovideo.com/c/search?q=rtx+5090' },
        { store: 'eBay used ~$3,658-3,850 floor May 30 (GPU Poet May 2026 lowest-avg ~$3,658; 30-day sold avg ~$4,000+; basically ties B&H 1P at $3,799.95 and Newegg FE at $3,695)', url: 'https://www.ebay.com/sch/i.html?_nkw=rtx+5090&_sop=12' },
  ...
  motherboard: [
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg 3P Speed Electronics $243.33 NEW May 30 (10% off $272.08, ships Hong Kong \u2014 DOWN ~$60 from HeLiXing $304; Newegg-direct not stocked at this tier)', url: 'https://www.newegg.com/msi-mag-z790-tomahawk-max-wifi-atx-intel-z790-lga-1700/p/N82E16813144633' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⭐ Newegg-direct $229.99 May 30 (QC WebFetch-verified live on PDP — list $259.99 -$30/11% off, sold/shipped by Newegg, limit 5, free 30-day returns, #1 Best Seller in AMD Motherboards; bundle BFEDY2A66 NOT on PDP today)', url: 'https://www.newegg.com/msi-mag-x870-tomahawk-wifi-atx-motherboard-amd-x870-am5/p/N82E16813144667' },
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: false,
      notes: 'Premium AM5 - 5x M.2 (3x PCIe 5.0), WiFi 7, 5GbE, USB4. Best-in-class. \uD83D\uDC8E Newegg-direct $399.99 May 30 RE-VERIFIED on PDP (list $443.99 -$44 / 9% off, sold/shipped by Newegg, limit 2/customer, #4 Best Seller in AMD Motherboards; flat 3+ day hold from May 27). Pangoly $369 composite is PHANTOM— no major retailer match — CompSource shows $470.59 May 12; likely aggregating an expired/regional offer). Best Buy $417.99 May 30 (marked from $513.36, saves $95.37) is the verified backup 1P. 3P marketplace alts antonline $502 / NothingButSavings $512 sit well above Newegg-direct. Amazon $419 still listed but Newegg now the cheapest authorized channel. \u26A0\uFE0F Best Buy ~$419 (tariff-volatile). ASUS eShop $500 MSRP. \u26A0\uFE0F Price stabilized from $699 spike in Feb 2026 but 32% Taiwan tariff pressure building. \u2B50 ASUS $30 Steam code promo last CONFIRMED active Mar 11 2026 (Tweaktown; covers Strix X870E-E/H + others) \u2014 UNCONFIRMED past mid-April, "limited-time" with no verified end-date; verify on ASUS eShop before counting on it.',
      advice: 'PREMIUM: Newegg-direct $399.99 May 30 RE-VERIFIED on PDP (list $443.99 -$44 / 9% off, sold/shipped by Newegg, limit 2/customer, #4 Best Seller in AMD Motherboards; flat 3+ day hold from May 27). Beats Amazon $419 by $19. ⚠️ Pangoly $369 composite is PHANTOM — no major retailer match (CompSource shows $470.59 May 12; likely aggregating an expired/regional offer). Best Buy $417.99 May 30 verified (marked from $513.36). Treat $369 (unverified at any major retailer \u2014 treat as transient 3P, not the buyable price. Best Buy ~$419 ties Amazon. $30 ASUS Steam code only via ASUS eShop ($500) = ~$470 effective, still not worth it. ~$170 more than X870 Tomahawk ($229.99 Newegg 1P May 30) for USB4, 5x M.2, premium VRMs. Hard to justify for a 9800X3D gaming build \u2014 buy if you actually need USB4 + 5x M.2.',
      sources: [
      ...
      buyLinks: [
        ...
        { store: '⭐ Newegg-direct $399.99 May 30 RE-VERIFIED on PDP (1P, list $443.99 -$44 / 9% off, limit 2/customer, free 30-day returns, #4 Best Seller in AMD Motherboards; flat 3+ day hold; Pangoly $369 composite is PHANTOM, no major retailer match)', url: 'https://www.newegg.com/asus-rog-strix-x870e-e-gaming-wifi-atx-motherboard-amd-x870e-am5/p/N82E16813119682' },
  ...
  ram: [
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $479.99 list May 30 (\u2b50 CODE LUSF245 -$40 = $439.99 net, QC-re-verified active on PDP, 3-day hold; replaces expired MFSF278; 3P Circuit Nest $438.97 ties net)', url: 'https://www.newegg.com/g-skill-flare-x5-32gb-ddr5-6000-cas-latency-cl36-desktop-memory-black/p/N82E16820374419' },
  ...
  cooling: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '\u2b50\u2b50 Amazon ~$83.99 Non-RGB Black STILL ACTIVE May 30 (4-day post-holiday survival via Arctic store; \u26a0\ufe0f ARGB Black $91.49 deal EXPIRED May 27, reverted to ~$110-124 MSRP) \u2014 Newegg 1P gone Apr 30, Amazon is the path', url: 'https://www.amazon.com/Parent-ARCTIC-Liquid-Freezer-III/dp/B0F2TRHJX3' },
    ...
    },
    {
      ...
      advice: 'LUXURY: ⭐ Corsair.com $159.99 weekly-deal CONFIRMED still live May 30 (Best Seller, free shipping, in stock — marked down from $199.99-$239.99 list; 1P Best Seller historically \u2014 verify price on page; beats Amazon ~$190.99). ⭐ Best Buy NOW MATCHING at $159.99 (NEW 1P alt May 30). Gap to Arctic stays ~$76 (Arctic Non-RGB Black $83.99 hold Day 4). Newegg-direct still OOS. Still buy for iCUE/aesthetics, not thermals.',
      sources: [
  ...
  storage: [
    {
      ...
      buyLinks: [
        { store: 'Amazon ~$290 holds May 30 (Pangoly confirms sustained since the May 6 jump from $245; high $649.98 Mar 21; verify at checkout)', url: 'https://www.amazon.com/Crucial-P310-2280-PCIe-Gen4/dp/B0DC8RVRBZ' },
        { store: 'Best Buy ~$260 (last verified May 25, no fresh signal)', url: 'https://www.bestbuy.com/site/searchpage.jsp?st=crucial+p310+2tb' },
        { store: '⭐ Newegg-direct $284.99 May 30 DOWN $15 from $299.99 May 25 (1P, limit 3, free shipping; 3P BioStar $283.95 just below)', url: 'https://www.newegg.com/crucial-2tb-p310-nvme/p/N82E16820156413' }
      ]
    },
    {
      id: 'ssd-2tb',
      ...
      buyLinks: [
        ...
        { store: '\u2b50\u2b50\u2b50 Amazon Memorial Day $389.99 EXTENDED Day 4 May 30 (Gizmodo "final clearance push"; 39% off $639 list; cheapest 990 Pro 2TB in months; snapback risk HIGH next 24h, $429 likely post-holiday equilibrium)', url: 'https://www.amazon.com/SAMSUNG-Internal-Expansion-MZ-V9P2T0B-AM/dp/B0BHJJ9Y77' },
        { store: '\u2b50\u2b50 Newegg-direct $389.99 May 30 RE-VERIFIED (1P, both non-heatsink MZ-V9P2T0B/AM and heatsink MZ-V9P2T0CW variants; limit 5/customer; 3P floor PlatinumMicro $388.99 ties)', url: 'https://www.newegg.com/samsung-2tb-990-pro-nvme-2-0/p/N82E16820147861' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⭐ Newegg 3P floor DROPPED May 30: MEMORYnMORE $809.95 (NEW floor, DOWN $30 from BioStar $839.95 May 29; cluster behind: BioStar $839.95 / EvoMicro $839.99 / MobileMonster $849 / BestDealsForYou $864.99; Newegg-direct not stocked — vet 3P seller rating)', url: 'https://www.newegg.com/samsung-4tb-990-pro-nvme-2-0/p/N82E16820147879' }
      ]
    }
  ],
  case: [
    {
      ...
      buyLinks: [
        { store: '⚠️ Newegg $114.99 May 30 (1P direct Black; sale ENDED 5+ days ago — UP $30 from $84.99 26%-off that held May 5-25; QC WebFetch-verified on Newegg PDP; wait for sale to return)', url: 'https://www.newegg.com/corsair-atx-mid-tower-frame-4000d-rs-argb-steel-tempered-glass-computer-case-black/p/N82E16811139230' },
    ...
    },
    {
      ...
      price: 103,
      recommended: false,
      notes: 'Proven airflow champ. 160mm fans, 392mm GPU clearance. \u2B50 Best Buy $102.99 holds May 30 (HIGH confidence, 216RX Black ARGB; base 216 stable, RGB variants $112-133 on Amazon). ⭐ Newegg-direct $102.99 holds May 30 (QC WebFetch on PDP confirms 1P, sold/shipped by Newegg — the research agent\'s "lifted to $120.99" claim was FALSE, QC reverted; flat vs May 25). $10 gift card promo last confirmed Apr 21 — STILL UNVERIFIED May 17, treat as possibly lapsed (effective net ~$93 IF still live). \u26A0\uFE0F Amazon prior $167 spike unable to re-verify, listings active but dynamic pricing \u2014 Newegg best with gift card, otherwise Newegg/Best Buy tied at $102.99.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW Review', url: 'https://www.tomshardware.com/reviews/lian-li-lancool-216-review' }
      ],
      buyLinks: [
        { store: '⭐ Best Buy $102.99 May 30 (confirmed, HIGH confidence, 216RX Black ARGB)', url: 'https://www.bestbuy.com/product/lian-li-lancool-216rx-black-steel-tempered-glass-atx-mid-tower-with-2x-16cm-argb-fans-black/J39TC2KZJ9' },
        { store: '⭐ Newegg-direct $102.99 May 30 (QC WebFetch on PDP confirms 1P, sold/shipped by Newegg — research agent\'s "lifted to $120.99" claim was FALSE, QC reverted; $10 gift card promo UNVERIFIED, treat as possibly lapsed)', url: 'https://www.newegg.com/lian-li-atx-mid-tower-steel-tempered-glass-cases-black-lancool-216rx/p/2AM-000Z-000A8' },
  ...
  psu: [
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'ATX 3.1, 1000W Gold, compact 140mm. Headroom for any GPU. ⭐ Newegg BLACK SKU N82E16817139337 holds $169.99 May 30 (10% off $189.99 MSRP, $20 savings; sold/shipped by Newegg, limit 3/customer, free 30-day returns; 20-day hold from May 10). ⚠️ The research agent claimed "Newegg LIFTED to $174.99" — that was WHITE-SKU confusion AGAIN (white N82E16817139342 is $174.99 off $179.99, but BLACK is still $169.99). QC reverted; this is the second nightly in a row to make the white/black RM1000e SKU mistake (Best Buy version of the same error is already documented below). \u2b50 Pangoly tracker shows $149.99 current May 10 (RM1000e 2025 refresh) \u2014 UNVERIFIED at Newegg-direct, may be 3P spot or aggregator stale data; verify before treating as floor. Amazon ~$170. ⭐ Best Buy BLACK SKU (J39QHT28XQ) $147.99 last verified May 25 (no fresh signal this cycle; treat as still cheapest 1P if holding). B&H ~$175. \u2B50 Per Newegg listing, GIGABYTE RTX 5080 WindForce OC May 10 ships with FREE 1000W 80+ Gold PSU (combo holds since May 2 — 8 days) \u2014 if you\'re buying that GPU, skip a separate PSU here.',
      advice: '',
      sources: [
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'Titanium efficiency (95.2%), virtually silent, 10yr warranty. Amazon ~$230. \u2b50 Newegg REVERSED to $249.90 May 30 (DOWN $9.59 from $259.49 May 29 lift \u2014 gave back the bump in 24h; sold/shipped by Newegg, limit 10/customer; QC research snippet confirms). Best Buy $259.49 likely stale post-Newegg-reversal \u2014 verify. CompSource $237.62 (Mar 11 ref, possibly stale). Pangoly best price $229.90 (composite, may reflect 3P stock). Newegg $249.90 STILL NOT re-confirmed May 25 (CompSource $237.62, Amazon ~$230 — possible softening still in play) (other retailers $229.90-237.62, Amazon ~$230 — possible softening). ⚠️ Dark Power 14 1000W successor (ATX 3.1, Cybenetics Titanium) now listed on Amazon — may pressure DP13 pricing/value down. Still ATX 3.0 (not 3.1 like Corsair units).',
      advice: '',
      sources: [
        { label: 'be quiet! Official', url: 'https://www.bequiet.com/en/powersupply/4046' }
      ],
      buyLinks: [
        { store: '⭐ Newegg $249.90 May 30 (REVERSED — DOWN $9.59 from $259.49 May 29 lift; sold/shipped by Newegg, 1P, limit 10/customer; QC research snippet-confirmed)', url: 'https://www.newegg.com/be-quiet-atx-3-0-compatible-1000-w-80-plus-titanium-certified-power-supplies-black/p/1HU-004H-000R8' },
