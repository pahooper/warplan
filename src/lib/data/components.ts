...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⚠️ Amazon $438.99 May 15 (LIFTED $29 from May 11 ATL $409.95 — the May 11 floor held just 1 day; Pangoly tracker confirms $438.99 ATL print from May 2 holding through May 15 via WebSearch — 13-day hold at this lifted floor; free Crimson Desert bundle still listed)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: '⭐⭐ Newegg-direct $419.99 with code SSF6798 May 15 (1P, $20 off $439.99 sale price; ⭐ free Corsair CX750M 750W PSU + Gamdias Boreas E2-410WH air cooler + McAfee Total Protection bundle still ACTIVE per VideoCardz May 14; sold/shipped by Newegg, limit 1; code verified live May 15 via PC Gamer + Tom\'s Guide + TechRadar coupon trackers)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
  ...
  gpu: [
    {
      ...
      advice: 'BUDGET PICK MAY 15: 5080 $999 MSRP window slammed shut <24 hours after May 14 reopen — current authorized 5080 floor is $1,299 Amazon PNY ARGB EPIC-X (4-day hold), so the 5070 Ti regains its value-pick role. The 5070 Ti is 15-18% slower than the 5080 but $320 cheaper at current pricing. ASUS PRIME 16G $899.99 Newegg-direct STILL OOS 9+ days in (1P listing shows $899.99 list with PRAGMATA bundle but stock depleted since May 7; 3P SenyTech Global $1,229.99 cheapest, range to $1,339). Cheapest 1P in-stock 5070 Ti is MSI Ventus 3X PZ OC BLACK at $979 Newegg (PRAGMATA, "lowest in 30 days", flat May 10-15 — 5+ day hold). Amazon ASUS PRIME OC $999 per bestvaluegpu May 14-15 (cheapest Amazon authorized 1P). eBay used $875 (bestvaluegpu May 15 floor — ~$104 below new for warranty risk). ⭐ RTX 5060 Ti (16GB, $429) is the budget alternative if 4K@160Hz isn\'t a hard target. ⚠️ Buy plan: 5070 Ti $979 Newegg if you\'re OK with DLSS-dependent 160Hz; step to 5080 $1,299 Amazon for native 4K@160Hz margin. If a $999 5080 SFF flashes back to Newegg, drop everything and grab it. ⚠️ PRAGMATA bundle ENDED May 12 (codes redeemable on Steam through June 9 for qualifying May 12 buys — no lever for May 15+).',
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⭐ Amazon PNY ARGB EPIC-X $1,299 holds May 15 (4-day hold from May 11 per bestvaluegpu/gpudeals.net — cheapest authorized 1P now that Newegg $999 MSRP SKUs are OOS)', url: 'https://www.amazon.com/s?k=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⚠️ eBay used $3,700 floor May 15 (UP $200 from May 11 $3,500 per bestvaluegpu refresh; floor trajectory Apr 30 $3,580 → May 11 $3,500 → May 15 $3,700, scalper exhaustion arc stalled; only ~$99 below Newegg 1P $3,799 now)', url: 'https://www.ebay.com/sch/i.html?_nkw=rtx+5090&_sop=12' },
  ...
  motherboard: [
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: true,
      notes: '\u2B50 SWEET SPOT AM5 - WiFi 7, 5GbE, PCIe 5.0 M.2, 8-layer server-grade PCB. The 9800X3D doesn\'t need more. Amazon $226.99 holds May 15 (Pangoly tracker confirms via WebSearch May 15, ATL $219.99 Apr 2, flat since May 2 \u2014 13-day hold). \u2b50 Newegg 1P direct $229.99 holds May 10 (#1 best-seller AMD MB, "Lowest Price in 30 Days" badge confirmed via direct page check May 10; sold and shipped by Newegg, saving $24.50/9% off list $254.49, limit 5/customer; 5-day hold at $229.99 since May 5 1P pivot). The 3P-only era ENDED. MSI Store still OUT OF STOCK May 10 (email-when-back notify only). Best Buy now $229.99 May 15 (marked down from $259.99 per WebSearch May 15 — joins Newegg at $229.99, ties Newegg 1P exactly). Amazon at $226.99 remains the floor by $3.',
