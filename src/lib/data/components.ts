  ...
  cpu: [
    {
      ...
      advice: 'AT 4K: Only 1-5% behind 9800X3D because GPU is the bottleneck. Keeping it is valid IF your chip shows no instability. BUT: degradation risk is real, resale dropping fast \u2014 eBay used listings $250-305 (May 2 spot check; range holds vs Apr 30 \u2014 BIN listings $290-375 with active bids per eBay sort — Arrow Lake Refresh + 9800X3D dropping to $439 are both pulling buyer attention), new sealed retail $370-441 (Pangoly retail unchanged ~$441 May 2); Newegg still $469 with $130 off + extra 10% via code "NTEL37" + free Corsair CX750M 750W PSU bundle (NTEL37 verified live May 2 per Tom\'s HW Newegg promo coverage; code captured Apr 24, still active). After eBay fees (~13%) expect ~$217-265 net used. Platform is a dead end. \u26A0\uFE0F\u26A0\uFE0F SELL NOW: Arrow Lake Refresh 270K Plus ($299 MSRP, ~$349 street May 2, narrowed from $329-357 launch range per Tom\'s HW dynamic pricing tracker — still ~17% over MSRP) is the buyers\' alternative — already tariff-bumped, narrowing the value delta vs used 14900K. \u26A0\uFE0F Intel May 2026 hike CONFIRMED at 8-10% AND LIVE since May 1 (Tech4Gamers + TechPowerUp + TweakTown corroborating, day 2 of rollout May 2 \u2014 retail moves still pending but watch this week) \u2014 stacks on Feb 10-15% + Mar ~15%, cumulative 2026 trajectory ~30% YoY. New Intel chips getting pricier, firming used 14900K floor slightly. 250K Plus $199 MSRP (~$219-249 street), 250KF Plus $199.99. No 290K Plus coming (Intel confirmed scrapped). 9950X3D2 launched Apr 22 (only 0.8% gaming uplift over 9800X3D per TechSpot/Tom\'s HW/Phoronix/KitGuru) further depresses Intel high-end demand. List Langley\'s chip at $290-305 BIN to net ~$252-265 after fees \u2014 the eBay top end softened slightly as the 9800X3D dropped to $419.95 Amazon ATL May 2 (down $60 from launch \u2014 sharper buyer shift away from Intel high-end), so list at $290-305 BIN to clear faster. Don\'t wait past the May Intel hike \u2014 listing fatigue + Arrow Lake reviews tilting attention away from LGA1700 outweigh the short-term halo. Run stability benchmarks + screenshot before listing (buyers are wary).',
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Amazon $419.95 ATL May 2 (DOWN $20 vs May 1; $60 off $479, free Crimson Desert bundle, 1P direct)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: 'Newegg-direct $439.99 standalone (1P, holds May 2; $20 above Amazon \u2014 Amazon is the move now)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
        { store: 'Newegg $454 + FREE MSI Coreliquid A13 360mm AIO (code: BFEFE36 in cart, ongoing combo since Nov 2025, live May 2 \u2014 net $344 if you needed an AIO)', url: 'https://www.newegg.com/p/pl?d=amd+ryzen+7+9800x3d' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $639.99 (8% off $699 MSRP, in stock 1P May 2, limit 1, free Corsair CX750M 750W PSU bundle ACTIVE)', url: 'https://www.newegg.com/amd-ryzen-9-9000-series-ryzen-9-9950x3d-granite-ridge-socket-am5-desktop-cpu-processor/p/N82E16819113884' }
      ]
    }
  ],
  gpu: [
    {
      ...
      perf4k: 72,
      tdp: 300,
      notes: '\u26A0\uFE0F QUASI-EOL \u2014 ASUS told retailers production ended, then denied it; NVIDIA says "not EOL" but GDDR7 shortage has effectively halted restocking. NVIDIA cutting gaming GPU production 30-40% in H1 2026 \u2014 5070 Ti is FIRST target for cuts. 50 SUPER lineup indefinitely delayed (confirmed CES 2026) \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028 (Tom\'s HW). \u2b50\u2b50 NEW FLOOR May 2 \u2014 Newegg-direct ASUS PRIME RTX 5070 Ti 16G $899.99 (1P, in stock, PRAGMATA bundle), DOWN $100 from the $999.99 floor that held Apr 27 - May 1. Verified live via Newegg listing scrape May 2. Next 1P tier $989.99-$999.99: MSI Shadow 3X OC $989.99, Zotac SOLID SFF OC $999.99, MSI Ventus 3X OC BLACK $999.99, Gigabyte WindForce $999.99 (all 1P; PRAGMATA bundles where applicable). Mid-tier $1,019-1,159 (PNY ARGB, Gigabyte AERO OC). Amazon floor $999 (ASUS PRIME OC per bestvaluegpu May 2, DOWN from $1,049 PNY ARGB Apr 30). ASUS publicly DENIED EOL claim Apr 2026 (Tom\'s HW) but confirmed memory supply impacted production \u2014 supply tight but not collapsing. Micro Center average $930 across locations (one MSRP card at $899 \u2014 see VideoCardz). Best Buy ~$1,069-1,299. eBay used ~$869.99. Peaked at $1,220 in mid-2025. ~54fps avg native 4K, DLSS 4.5 Dynamic MFG 6x live (596.21/596.36 WHQL drivers; 596.36 added Conan Exiles Enhanced May 5) \u2014 auto-targets 160Hz, 6x mode for path-traced titles. \u2b50 PRAGMATA bundle ACTIVE Apr 14 - May 12 (redeem by June 9) on select 5070 Ti / 5080 / 5090 \u2014 10 DAYS LEFT. Stock depleting \u2014 new units may not be replenished.',
      advice: '\u2B50\u2B50 BIG MOVE May 2 \u2014 the 5070 Ti floor cracked: ASUS PRIME 16G at $899.99 Newegg-direct (1P in stock, PRAGMATA bundle), DOWN $100 from the $999.99 floor that held since Apr 27. Now $400 below the cheapest in-stock 5080 ($1,299.99 Newegg). Suddenly a much more rational budget pick — save $400 for ~15-18% less performance. Amazon ASUS PRIME OC at $999 is the next-best path. STILL: only buy if 4K@160Hz isn\'t a hard requirement (native fps avg ~54, leans heavily on DLSS 4 MFG). Otherwise step up to the 5080. \u2B50 RTX 5060 Ti (16GB, $429) is the budget alternative if 4K@160Hz isn\'t a hard target. Supply not recovering \u2014 if the $899 PRIME flips OOS, expect to pay $999+ again. PRAGMATA bundle expires May 12 (10 days left).',
      whyNot: 'Native 4K performance averages ~54fps. Needs DLSS 4 MFG to hit 160Hz, and not all games support it yet. 16GB VRAM may limit future 4K titles. With the 5080 floor at $1,299 Newegg, the gap is now $400 \u2014 only buy the 5080 if 160Hz@4K is a hard target. The 5070 Ti is finally priced like a budget card again.',
      ...
      buyLinks: [
        { store: 'Newegg-direct $899.99 ASUS PRIME 16G (1P, in stock May 2, PRAGMATA bundle — NEW FLOOR, down from $999.99 that held Apr 27 - May 1)', url: 'https://www.newegg.com/p/pl?d=rtx+5070+ti' },
        ...
        { store: 'Amazon $999 (ASUS PRIME OC, bestvaluegpu May 2 — down from $1,049 PNY Apr 30)', url: 'https://www.amazon.com/s?k=rtx+5070+ti' },
    ...
    },
    {
      ...
      perf4k: 90,
      tdp: 360,
      notes: '\u2B50 SWEET SPOT FOR 4K@160Hz - DLSS 4 MFG turns 68fps native into 238fps in Cyberpunk. \u2B50 $999 MSRP WINDOW STILL CLOSED May 2 \u2014 Newegg floor steady at $1,299.99 (Zotac SOLID OC White, 1P, in stock; flat vs Apr 28-May 1). Next 1P in stock: PNY ARGB OC $1,329.99, GIGABYTE WindForce OC $1,349.99, ZOTAC GAMING Apocalypse OC $1,399.99, ZOTAC AMP Extreme Infinity $1,399.99 (GIGABYTE WindForce ships with FREE 1000W 80+ Gold PSU + PRAGMATA bundle May 2 \u2014 NEW combo). Mid-tier $1,399-1,469 (PNY ARGB, ASUS PRIME). Amazon $1,299 (ZOTAC SOLID CORE OC per bestvaluegpu May 2 \u2014 UP $50 from Apr 30 floor; Amazon now matches Newegg, undercut window closed). Micro Center ~$1,150-1,250 in-store (varies by model). Best Buy ~$1,260+. eBay used ~$1,150 (down from ~$1,199 Apr 30). \u26A0\uFE0F GDDR7 shortage + NVIDIA 30-40% production cuts, but 5080 is NVIDIA\'s PRIORITY 16GB card \u2014 better supply outlook than 5070 Ti. \u2B50 DLSS 5 announced at GTC 2026 (Fall 2026, RTX 50 exclusive) \u2014 neural rendering breakthrough, photoreal lighting via AI, massive future upgrade. DLSS 4.5 Dynamic MFG 6x live (596.21/596.36 WHQL drivers; 596.36 added Conan Exiles Enhanced May 5). 250+ MFG-compatible games. Prices peaked at $1,500 in Aug 2025; the brief Newegg $999 MSRP window held about a week before lifting to $1,299 on Apr 25-26.',
      advice: 'RECOMMENDED: Best realistic path to 160Hz@4K. \u2B50 $999 MSRP WINDOW STILL CLOSED May 2! Newegg floor steady at $1,299.99 (Zotac SOLID OC White, 1P, flat vs Apr 28-May 1), then PNY ARGB OC $1,329.99, GIGABYTE WindForce OC $1,349.99 (with FREE 1000W 80+ Gold PSU + PRAGMATA \u2014 NEW May 2 combo). Amazon $1,299 (ZOTAC SOLID CORE OC, UP $50 vs Apr 30 \u2014 the Amazon-undercut window closed; now matches Newegg). \u26A0\uFE0F GAP TIGHTENED vs 5070 Ti: 5070 Ti dropped to $899.99 ASUS PRIME Newegg-direct May 2 (NEW FLOOR), so the 5080 premium is now $400 for ~15-18% more perf. Still the right pick if 4K@160Hz is a hard target \u2014 the 5070 Ti can\'t reliably hit 160Hz native, the 5080 can with DLSS 4 MFG. \u2B50 DLSS 5 coming Fall 2026 (RTX 50 exclusive, neural rendering) \u2014 buying the 5080 now means you get DLSS 5 support when it lands. NVIDIA prioritizing 5080 production. SUPER refresh indefinitely delayed (confirmed CES 2026). \u2b50 PRAGMATA bundle ACTIVE Apr 14 - May 12 on select 5080s (redeem by June 9) \u2014 10 DAYS LEFT. \u2b50 GIGABYTE WindForce OC $1,349.99 + free 1000W PSU is the new value play if you also need a PSU \u2014 effective net ~$1,180 if you wanted an RM1000e or equivalent.',
      ...
      buyLinks: [
        { store: 'Newegg $1,299.99 (ZOTAC SOLID OC White, 1P floor \u2014 holds since Apr 26, confirmed May 2)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: 'Newegg $1,349.99 GIGABYTE WindForce OC + FREE 1000W 80+ Gold PSU + PRAGMATA bundle (NEW May 2 combo, 1P)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: 'Amazon $1,299 (ZOTAC SOLID CORE OC, bestvaluegpu May 2 \u2014 UP $50 from $1,249 Apr 30, Amazon-undercut window closed)', url: 'https://www.amazon.com/s?k=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Micro Center ~$2,910 (ASUS TUF OC, in-store, unverified May 2)', url: 'https://www.microcenter.com/search/search_results.aspx?Ntt=rtx+5090' },
        { store: 'Newegg-direct $3,699.99 ZOTAC SOLID OC (1P desktop floor, in stock May 2)', url: 'https://www.newegg.com/p/pl?d=rtx+5090' },
        { store: 'Newegg ASUS TUF: 3P only $4,199-5,099 (1P still GONE May 2)', url: 'https://www.newegg.com/asus-tuf-gaming-tuf-rtx5090-32g-gaming-geforce-rtx-5090-32gb-graphics-card-triple-fans/p/N82E16814126752' },
        { store: 'Amazon ~$3,899 (ASUS ROG Astral OC, bestvaluegpu May 2)', url: 'https://www.amazon.com/s?k=rtx+5090' },
        { store: 'B&H Photo $3,799.95 MSI Suprim Liquid SOC', url: 'https://www.bhphotovideo.com/c/search?q=rtx+5090' },
        { store: 'eBay used ~$2,700 (bestvaluegpu May 2, DOWN ~$880 from $3,580 Apr 30 \u2014 cheaper than new for first time)', url: 'https://www.ebay.com/sch/i.html?_nkw=rtx+5090&_sop=12' },
  ...
  motherboard: [
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg ~$304 (3P "HeLiXing" HK, holds May 2; was $346 Apr 29 \u2014 tariff partial reversal)', url: 'https://www.newegg.com/msi-mag-z790-tomahawk-max-wifi-atx-intel-z790-lga-1700/p/N82E16813144633' },
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: true,
      notes: '\u2B50 SWEET SPOT AM5 - WiFi 7, 5GbE, PCIe 5.0 M.2, 8-layer server-grade PCB. The 9800X3D doesn\'t need more. Amazon $226.99 May 2 (Pangoly tracker, ATL $219.99 Apr 2, holds flat vs Apr 28-May 1). Newegg listing $239.99 May 2 (3P shipped by Newegg \u2014 holds since Apr 27 drop from $299.99; QC-verified at checkout May 2, NOT 1P direct). MSI Store still OUT OF STOCK May 2 (email-when-back notify only). Best Buy ~$254. Amazon at ~$227 remains the floor May 2.',
      advice: 'RECOMMENDED: ~$227 at Amazon (still the floor May 2) or Newegg listing $239.99 (3P shipped by Newegg, holds since Apr 27 drop from $299.99 Apr 26 \u2014 QC-verified at checkout May 2, not 1P direct). \u26A0\uFE0F Newegg jumped to $300 from tariffs in late April \u2014 partial reversal stuck so far. AM5 with WiFi 7 + 5GbE + upgrade path through 2027+ (Zen 6 "Medusa" desktop delayed to 2027, AM5 confirmed). The 9800X3D doesn\'t need a $500 board. Tariff-driven flux on both boards (Z790 $212-300, X870 ~$227-240) keeps the gap small, and the X870 has a platform future. \u26A0\uFE0F Amazon/MSI prices likely to follow Newegg\'s tariff increase soon. Buy now.',
      sources: [
      ...
      buyLinks: [
        { store: 'MSI Store OUT OF STOCK May 2', url: 'https://us-store.msi.com/MAG-X870-TOMAHAWK-WIFI' },
        { store: 'Amazon $226.99 (best! Pangoly May 2)', url: 'https://www.amazon.com/MSI-Tomahawk-Motherboard-Processors-Bluetooth/dp/B0DG3HK897' },
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: false,
      notes: 'Premium AM5 - 5x M.2 (3x PCIe 5.0), WiFi 7, 5GbE, USB4. Best-in-class. \uD83D\uDC8E Newegg-direct $399.99 1P (holds since Apr 28 restock; per-customer limit lifted Apr 30, holds May 2) — full reversal of yesterday\'s stockout where only 3P sat at $500+. TECH EDGE 3P alt $398 ties. Amazon $419 still listed but Newegg is now the cheapest authorized channel. Pangoly $369 spot appears stale/transient. \u26A0\uFE0F Best Buy ~$419 (tariff-volatile). ASUS eShop $500 MSRP. \u26A0\uFE0F Price stabilized from $699 spike in Feb 2026 but 32% Taiwan tariff pressure building. \u2B50 ASUS $30 Steam code promo CONFIRMED ACTIVE April 2026 (covers Strix X870E-E/H plus many others \u2014 per Tweaktown Apr coverage; no updated end-date confirmed beyond prior July 1).',
      advice: 'PREMIUM: Newegg-direct $399.99 holds May 2 (1P, per-customer limit lifted, since Apr 28 restock) \u2014 that\'s the new authorized floor and undercuts Amazon $419. Best Buy ~$419 ties Amazon. $30 ASUS Steam code only via ASUS eShop ($500) = ~$470 effective, still not worth it. $172+ more than X870 Tomahawk ($227 Amazon) for USB4, 5x M.2, premium VRMs. Hard to justify for a 9800X3D gaming build \u2014 buy if you actually need USB4 + 5x M.2.',
      sources: [
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $399.99 holds May 2 (1P, per-customer limit lifted; TECH EDGE 3P $398 ties)', url: 'https://www.newegg.com/asus-rog-strix-x870e-e-gaming-wifi-atx-motherboard-amd-x870e-am5/p/N82E16813119682' },
  ...
  ram: [
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $449.99 sale (list $494.99; code PGWEF295 \u2014$70 off \u2192 ~$424.99 net May 2)', url: 'https://www.newegg.com/g-skill-flare-x5-32gb-ddr5-6000-cas-latency-cl36-desktop-memory-black/p/N82E16820374419' },
    ...
    },
    {
      ...
      capacity: 32,
      recommended: false,
      notes: 'Tighter CL30 timings for ~1-2% more gaming perf. AMD EXPO + Intel XMP 3.0 certified. Amazon ~$474 (best!). Newegg-direct $489.99 holds May 2 (was $499.99 Apr 28; non-RGB SKU KF560C30BBEK2-32, $135 / 21% off $624.99 list, sold/shipped by Newegg, limit 5). 3P range $512-$527 (Amigos / BeachAudio / antonline). Best Buy ~$480. \u26A0\uFE0F DDR5 retail softening slightly in March (first drop in 8 months) but contract prices unchanged \u2014 caution on expecting big drops.',
      advice: 'PREMIUM TIMINGS: CL30 is technically optimal but now ~$115+ more than CL36 ($474 vs $359) for 1-2% real-world difference. Amazon ~$474 is the only sane CL30 price right now \u2014 Newegg-direct $489.99 (down from $499.99 Apr 28, holds May 2) is close but Amazon still cheaper. The CL30 premium is barely justified at $474; at $500+ it definitely isn\'t. Stick with Flare X5 CL36 at $359 Amazon.',
      sources: [
        { label: 'PC Gamer: Best RAM 2026', url: 'https://www.pcgamer.com/best-ram-for-gaming/' },
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $489.99 (down from $499.99 Apr 28, holds May 2; non-RGB SKU, $135/21% off $624.99 list)', url: 'https://www.newegg.com/kingston-technology-corp-fury-beast-32gb-ddr5-6000-cas-latency-cl30-memory-black/p/N82E16820242861' },
    ...
    },
    {
      ...
      capacity: 64,
      recommended: false,
      notes: '\u26A0\uFE0F\u26A0\uFE0F SEVERE SHORTAGE - 64GB DDR5 non-RGB ~$880 at Amazon, RGB variant ~$934-949 (WaveRide Tech ships from Canada, MD Discounts $965 shipped). Newegg $949.99 (3P EvoMicro, holds May 2). eBay $968. Pangoly peak was $1,045 in mid-Feb 2026. TrendForce Mar 31: DDR5 retail fell 7.2% MoM \u2014 first decline in 8 months, but Q2 contract hikes of 58-63% QoQ still being negotiated. Tom\'s HW: "64GB of DDR5 now costs more than an entire PS5." Pre-crisis this kit was $193 \u2014 current price is ~4.5x. PCGamer: "memory crisis could run past 2028." Structural shortage from AI data center demand.',
      ...
      buyLinks: [
        ...
        { store: 'Newegg RGB $949.99 (3P EvoMicro, holds May 2; B.Y.R $1,133 / WaveRide $1,144). Non-RGB SKU only Canada 3P at $1,274 \u2014 use Amazon for non-RGB.', url: 'https://www.newegg.com/g-skill-trident-z5-neo-rgb-series-64gb-ddr5-6000-cas-latency-cl30-desktop-memory-black/p/N82E16820374445' }
      ]
    }
  ],
  cooling: [
    {
      ...
      type: 'air',
      recommended: false,
      notes: 'Updated V2 of GN\'s "The Champ" air cooler. Amazon ~$40 holds May 2 (pcspecchart, crept up from $33 Apr 21 \u2014 some recent reviews still cite $33 figure). Newegg SE V2 $49.90 (Thermalright Authorized Store, top-rated, holds since Apr 28 \u2014 list price now matches sale). Dual-tower, 6 heatpipes, AGHP Gen 5.0, rated to 265W TDP. Supports LGA 1851/1700 and AM5.',
      advice: 'BUDGET: At ~$40 Amazon May 2 (crept up from $33 in April), still an absurd deal for 9800X3D (120W). Beats $80-100 towers at half the price. Newegg V2 $49.90 if Amazon out. NOT enough for i9-14900K under sustained 253W load.',
      sources: [
      ...
      buyLinks: [
        { store: 'Amazon ~$40 (up from $33 Apr 21, pcspecchart confirmed May 2)', url: 'https://www.amazon.com/Thermalright-Peerless-Assassin-120-Cooler/dp/B0DP23NF7T' },
    ...
    },
    {
      ...
      type: 'aio',
      recommended: true,
      notes: '\u2B50 GN "The New Best" AIO - 2C cooler than standard on AMD, 10C on Intel. Integrated VRM fan. Nothing else comes close. Amazon ~$105 Non-RGB Black holds May 2 (back up from $89 ATL; Tom\'s HW still cites $89 ATL but listing now $105). ARGB Black $91.49 May 2 (DOWN ~$3 from $94 Apr 30 \u2014 Amazon). ⚠️ Newegg first-party listing GONE Apr 30 — only 3P TELeasy at $165.99 / B-IN $169.99 (red flag — Amazon is the only sane path). Tom\'s HW: "Best AIO for 9950X3D and Intel too." Tech4Gamers: "Cooler To Beat In 2026."',
      advice: 'RECOMMENDED: ~$105 Amazon non-RGB Black holds May 2 for the best AIO ever tested. ARGB Black $91.49 May 2 (down ~$3 vs Apr 30) if you want lighting. Handles both 14900K and 9800X3D with ease. $86 cheaper than the Corsair Titan ($191) for better thermals.',
      sources: [
    ...
    },
    {
      ...
      type: 'aio',
      recommended: false,
      notes: 'Premium AIO - Corsair FlowDrive pump, hot-swap caps, iCUE ecosystem integration. LCD variant available at ~$250+. \u2b50 Corsair.com $159.99 holds May 2 (sale from $199.99, Best Seller, free ship, in stock \u2014 verified May 2; estimated delivery May 6-7). Amazon Pangoly ~$190.99 holds May 2. Newegg-direct $199.99 STILL OUT OF STOCK May 2; 3P Canadian seller WaveRide Tech $153.99 (held since Apr 28). Price volatile in 2026 \u2014 12-mo range $140-322, avg $191.',
      advice: 'LUXURY: ⭐ Corsair.com $159.99 holds May 2 (first-party Best Seller, free ship \u2014 beats Newegg OOS state, Amazon $190.99). Gap to Arctic narrowed to ~$55 (Arctic ~$105). Newegg-direct STILL OOS May 2. Still buy for iCUE/aesthetics, not thermals.',
      sources: [
      ...
      buyLinks: [
        { store: 'Corsair.com $159.99 (best!) \u2014 sale from $199.99, in stock May 2', url: 'https://www.corsair.com/us/en/p/cpu-coolers/cw-9061018-ww/icue-link-titan-360-rx-rgb-aio-liquid-cpu-cooler-cw-9061018-ww' },
        { store: 'Amazon ~$190.99 (Pangoly May 2)', url: 'https://www.amazon.com/CORSAIR-iCUE-Titan-Liquid-Cooler/dp/B0D6BFBLTK' },
        { store: 'Newegg-direct $199.99 STILL OOS May 2 ($153.99 from 3P WaveRide CA, holds since Apr 28)', url: 'https://www.newegg.com/p/0EZ-00MD-00003' }
      ]
    }
  ],
  storage: [
    {
      ...
      buyLinks: [
        { store: 'Amazon $200.99 (best! holds May 2, Pangoly tracker)', url: 'https://www.amazon.com/Crucial-P310-2280-PCIe-Gen4/dp/B0DC8RVRBZ' },
    ...
    },
    {
      ...
      price: 494,
      recommended: false,
      notes: 'Best Gen4 SSD. 7,450 MB/s read. Was $133 \u2014 NAND shortage has nearly 4.3x the price. \u26A0\uFE0F PRICE CLIMBING AGAIN: Amazon ~$583 (Pangoly $583.19 May 2, flat vs Apr 30; intra-month high $917.84 on Apr 21). Samsung.com $639.99. Newegg 3P BioStar $493.75 / MobileMonster $493.76 / Best Deals For You $494.99 (Newegg-direct not 1P). \u26A0\uFE0F The $493 Newegg 3P floor is still $90 BELOW Amazon 1P May 2 \u2014 best non-MC path. \u2B50 Micro Center ~$280 in-store still cited but UNVERIFIED May 2 (suspicious gap vs national channel — call store before driving). Still ~4.3x the $133 mid-2025 low. Hit $844 high on Mar 31, $917.84 high on Apr 21. \u26A0\uFE0F NAND CRISIS WORSENING: TrendForce Mar 31 forecasts Q2 2026 NAND contract prices +70-75% QoQ on top of Q1\'s ~60% jump. Phison CEO: all 2026 NAND production already sold out, "pricing apocalypse" through 2027. Enterprise SSDs now ~60% of global NAND output \u2014 consumer allocation shrinking. Volatile \u2014 verify at checkout, direction is UP.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW: 990 Pro Review', url: 'https://www.tomshardware.com/reviews/samsung-990-pro-ssd-review' }
      ],
      buyLinks: [
        { store: 'Micro Center ~$280 (UNVERIFIED May 2 — call store)', url: 'https://www.microcenter.com/product/661028/samsung-990-pro-2tb-ssd' },
        { store: 'Amazon ~$583 (Pangoly $583.19 May 2, flat vs Apr 30; intra-month high $917.84 \u2014 verify at checkout)', url: 'https://www.amazon.com/SAMSUNG-Internal-Expansion-MZ-V9P2T0B-AM/dp/B0BHJJ9Y77' },
        { store: 'Newegg 3P $493.75 (BioStar / MobileMonster $493.76 / Best Deals For You $494.99 \u2014 Newegg 1P not stocked May 2)', url: 'https://www.newegg.com/samsung-2tb-990-pro-nvme-2-0/p/N82E16820147861' },
    ...
    },
    {
      ...
      price: 899,
      recommended: false,
      notes: 'Single-sided 4TB. Premium for capacity. \u26A0\uFE0F PRICE CLIMBING AGAIN: Pangoly tracker $948.93 May 2 (flat vs Apr 30; UP ~$200 from $742.99 Apr 4 print). Conservative midpoint ~$899 (volatile, verify at checkout). Newegg 3P floor: ServerQue $849 holds May 2 (the $849 floor from Apr 28 \u2014 still the realistic floor; BioStar $978.75, Best Deals For You $978.94, E.O.L. Tech $1,000 above). 30-day avg $725 per pricehistory.app \u2014 ServerQue $849 is the realistic floor again. Hit $1,600 in Feb 2026. Was $250 in Nov 2023. Still ~3x the mid-2025 low. NAND crisis continues \u2014 Q1 2026 contract prices surged 55-60% QoQ, no relief until late 2027. Price volatile \u2014 check at purchase time.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW: 990 Pro Review', url: 'https://www.tomshardware.com/reviews/samsung-990-pro-ssd-review' }
      ],
      buyLinks: [
        { store: 'Amazon ~$899 (⚠️ UP from $743 Apr 4; Pangoly May 2 $948.93 \u2014 verify at checkout)', url: 'https://www.amazon.com/s?k=samsung+990+pro+4tb' },
        { store: 'Newegg 3P $849 ServerQue (holds May 2; BioStar $978.75 / Best Deals For You $978.94 above)', url: 'https://www.newegg.com/samsung-4tb-990-pro-nvme-2-0/p/N82E16820147879' }
      ]
    }
  ],
  case: [
    {
      ...
      buyLinks: [
        { store: 'Newegg $114.99 (1P direct, sale ENDED May 2 \u2014 was $84.99 Apr 30-May 1)', url: 'https://www.newegg.com/corsair-atx-mid-tower-frame-4000d-rs-argb-steel-tempered-glass-computer-case-black/p/N82E16811139230' },
  ...
  psu: [
    {
      ...
      wattage: 850,
      recommended: false,
      notes: 'ATX 3.1 (2025 refresh), native 12V-2x6, PCIe 5.1, 7yr warranty. Newegg $129.99 holds May 2 (flat since Apr 28 \u2014 10% off $144.99 MSRP, sold/shipped by Newegg, limit 3; \u26a0\ufe0f code SSF6437 still NOT visible on product page May 2 \u2014 treat as expired/built-in; coupon aggregators still reference it but unverifiable). Amazon ~$125. Best Buy ~$125. PCPartPicker lowest alt listing $109.99. Good for 9800X3D + 5080. \u26A0\uFE0F China PSU tariff stack: 45% current rate on imported AC/DC power supplies (100electronics/bravoelectro, Apr 2026) + distributors raised 6-10% in Jan \u2014 expect further hikes in H2 2026. Watch Slickdeals — the $95 flash has already recurred once this month.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg $129.99 (10% off, holds May 2; ⚠️ code SSF6437 still gone from product page \u2014 expired/built-in)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-850-w-cybenetics-gold-power-supply-black-rm850e/p/N82E16817139336' },
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'ATX 3.1, 1000W Gold, compact 140mm. Headroom for any GPU. Newegg $169.99 (10% off $189.99 MSRP, holds May 2 \u2014 verified live; up slightly from $164.99 13%-off floor that ran through May 1, but sale STILL ACTIVE not ended). Amazon ~$170. Best Buy ~$175. B&H ~$175. \u2B50 Per Newegg listing, GIGABYTE RTX 5080 WindForce OC May 2 ships with FREE 1000W 80+ Gold PSU \u2014 if you\'re buying that GPU, skip a separate PSU here.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        ...
        { store: 'Newegg $169.99 (10% off $189.99 MSRP, holds May 2; up from $164.99 13%-off May 1)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-1000-w-cybenetics-gold-power-supply-black-rm1000e/p/N82E16817139337' }
      ]
    },
    {
      id: 'dp13-1000',
      ...
      wattage: 1000,
      recommended: false,
      notes: 'Titanium efficiency (95.2%), virtually silent, 10yr warranty. Amazon ~$230. Newegg $234.90 holds May 2 (flat since Apr 27 \u2014 28% off $329.90 MSRP, limit 10/customer). Best Buy ~$259. CompSource $237.62 (Mar 11 ref). Still ATX 3.0 (not 3.1 like Corsair units).',
      advice: '',
      sources: [
        { label: 'be quiet! Official', url: 'https://www.bequiet.com/en/powersupply/4046' }
      ],
      buyLinks: [
        { store: 'Newegg $234.90 (28% off $329.90 MSRP, holds May 2)', url: 'https://www.newegg.com/be-quiet-atx-3-0-compatible-1000-w-80-plus-titanium-certified-power-supplies-black/p/1HU-004H-000R8' },
