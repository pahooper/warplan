...
export const components: ComponentData = {
  cpu: [
    {
      ...
      advice: 'AT 4K: Only 1-5% behind 9800X3D because GPU is the bottleneck. Keeping it is valid IF your chip shows no instability. BUT: degradation risk is real, resale dropping fast \u2014 eBay sold ~$200-280 used. After fees (~13%) expect ~$174-244 net used. Platform is a dead end. \u26A0\uFE0F\u26A0\uFE0F SELL NOW: Arrow Lake Refresh launched Mar 26 to rave reviews. 270K Plus ($299, 24 cores) obliterates the value proposition of a used 14900K \u2014 why buy a degradation-risk chip for ~$250 when $299 gets you a brand new 270K Plus? 250K Plus at $199 also available. Resale will crater as 270K Plus hits shelves. Run stability benchmarks + screenshot results before listing (buyers are wary). Expected $175-225 by summer.',
    ...
    },
    {
      ...
      perf4k: 95,
      tdp: 120,
      notes: '\u2B50 UNDISPUTED GAMING KING - 96MB 3D V-Cache, 30% faster than 14900K in gaming, runs cool at 120W. Amazon ~$420 (all-time low! $60 off MSRP), Micro Center $399 in-store ($379.99 w/ Insider card!), Newegg ~$464, Best Buy ~$479. Free Crimson Desert game ($69.99 value, launched Mar 19! Bundle thru Apr 25, redeem by May 23). 9850X3D ($499 MSRP, ~$480-500) only 3-7% faster \u2014 9800X3D remains the value king. Arrow Lake Refresh (270K Plus $299) launched Mar 26 but X3D still dominates gaming.',
  ...
  gpu: [
    ...
    },
    {
      ...
      perf4k: 90,
      tdp: 360,
      notes: '\u2B50 SWEET SPOT FOR 4K@160Hz - DLSS 4 MFG turns 68fps native into 238fps in Cyberpunk. \u26A0\uFE0F $999 MSRP deals appear sporadically on Newegg (MSI Shadow 3X OC, Zotac Solid Core) but sell out fast. Typical street $1,249+ (Zotac Solid Core OC on Amazon). FE $999 restocks on Best Buy (sells out in minutes). Micro Center ~$1,099-1,300 in-store. \u26A0\uFE0F GDDR7 shortage + NVIDIA 30-40% production cuts. 50 SUPER officially on hold \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028. DLSS 4.5 Dynamic MFG 6x launches Mar 31 (5 days!) \u2014 6x frame gen, auto-adapts to your 160Hz target.',
      advice: 'RECOMMENDED: Best realistic path to 160Hz@4K. Typical street $1,249 (Zotac Solid Core OC on Amazon/Newegg). $999 MSRP deals appear sporadically on Newegg \u2014 set alerts for MSI Shadow 3X OC and Zotac Solid Core. Street peaked at $1,500 in Aug 2025, now trending down. At $1,249, still 15-18% faster than 5070 Ti ($999) for $250 more \u2014 worth it for native 4K headroom. DLSS 4.5 Dynamic MFG 6x launches Mar 31 (5 days!) \u2014 generates 5 extra frames per real frame, auto-adapts to your 160Hz monitor. 20+ new path-traced titles announced at GDC 2026. No SUPER refresh coming \u2014 this is the card to buy.',
    ...
    },
    {
      ...
      perf4k: 99,
      tdp: 575,
      notes: '\uD83D\uDC8E ABSOLUTE FASTEST GPU - 30-69% faster than 5080. 32GB GDDR7. Street price $2,910-$3,595 (1.46-1.80x MSRP $1,999). Premium/liquid-cooled AIBs $3,300-5,000+. GDDR7 shortage structural \u2014 NVIDIA confirmed supply constraints through fiscal 2027. ASUS TUF ~$2,910 (cheapest AIB, Newegg). Amazon ~$3,000-4,232. Best Buy FE $1,999 sells out in under 8 min. Micro Center ~$2,910+ in-store (limited). eBay avg ~$4,000 (Tom\'s HW data, stabilizing from higher peaks). No SUPER refresh coming \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028. \u26A0\uFE0F Prices predicted to RISE to $3,800-4,400 by Q4 2026.',
  ...
  ram: [
    {
      ...
      capacity: 32,
      recommended: true,
      notes: '\u2B50 BEST VALUE - AMD EXPO certified. DDR5-6000 is the AM5 sweet spot (1:1 Infinity Fabric). Amazon ~$359 (price dropping fast!), Newegg ~$450 list (try code BGSF285 for ~$380). \u26A0\uFE0F DDR5 prices still elevated due to AI demand \u2014 data centers consuming 70% of all memory chips. Micron exited consumer RAM entirely \u2014 only Samsung & SK Hynix remain. March 2026 saw first 7.2% decline after 6 months of growth \u2014 peak may be behind us but shortage expected through 2028.',
      advice: '32GB is all you need for gaming (AAA uses ~20GB max). CL36 vs CL30 is ~1-2% gaming difference. Amazon ~$359 is the best price right now (down from $454!). Newegg ~$450 list \u2014 try code BGSF285 at checkout (may drop to ~$380). March showed first DDR5 price decline in 6 months \u2014 may be past the peak, but Micron leaving consumer RAM means supply stays tight.',
      sources: [
    ...
    },
    {
      ...
      capacity: 64,
      recommended: false,
      notes: '\u26A0\uFE0F\u26A0\uFE0F SEVERE SHORTAGE - 64GB DDR5 now ~$935 at Newegg (price easing from $1,026!), ~$1,141 at Amazon. Tom\'s HW: "64GB of DDR5 now costs more than an entire PS5." RAMageddon 2026 easing slightly \u2014 March saw first 7.2% decline. Still elevated above pre-crisis levels. AI demand consuming all HBM/DRAM fab capacity. Shortage expected until Q4 2027 at earliest, some analysts say 2028.',
      advice: 'OVERKILL FOR GAMING: Games use ~20GB max. You\'re paying ~$576-782 extra over 32GB ($935-1,141 vs $359) for capacity you\'ll never touch in games. Price easing from peak ($1,077) to ~$935 at Newegg. Amazon still overpriced at $1,141 \u2014 buy from Newegg if you must.',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg ~$935 (best!)', url: 'https://www.newegg.com/g-skill-trident-z5-neo-rgb-series-64gb-ddr5-6000-cas-latency-cl30-desktop-memory-black/p/N82E16820374445' },
  ...
  cooling: [
    ...
    },
    {
      ...
      type: 'aio',
      recommended: true,
      notes: '\u2B50 GN "The New Best" AIO - 2C cooler than standard on AMD, 10C on Intel. Integrated VRM fan. Nothing else comes close. Amazon ~$89 (Non-RGB black, price drop from $105!), ARGB ~$94-119. Tom\'s HW: "Best AIO for 9950X3D and Intel too." Tech4Gamers: "Cooler To Beat In 2026."',
      advice: 'RECOMMENDED: ~$89 on Amazon for the non-RGB black variant of the best AIO ever tested (was $105!). ARGB variant ~$94-119 if you want lighting. Handles both 14900K and 9800X3D with ease. $102 cheaper than the Corsair Titan ($191) for better thermals.',
      sources: [
  ...
  psu: [
    {
      ...
      wattage: 850,
      recommended: false,
      notes: 'ATX 3.1 (2025 refresh), native 12V-2x6, PCIe 5.1, 7yr warranty. B&H ~$125 (best!), Amazon ~$133, Newegg ~$135 (code SUSF66 confirmed active), Best Buy ~$145. Good for 9800X3D + 5080.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg ~$135 (code SUSF66)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-850-w-cybenetics-gold-power-supply-black-rm850e/p/N82E16817139336' },
