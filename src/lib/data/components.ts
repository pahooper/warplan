...
export const components: ComponentData = {
  cpu: [
    {
      ...
      perf4k: 82,
      tdp: 253,
      notes: '\u26A0\uFE0F DEGRADATION RISK - Intel confirmed voltage bugs causing permanent silicon damage. Microcode fixes PREVENT new damage but can\'t REVERSE existing damage. Intel extended warranty to 5 years. Reports of continued degradation even post-fix, though at reduced rates.',
      advice: 'AT 4K: Only 1-5% behind 9800X3D because GPU is the bottleneck. Keeping it is valid IF your chip shows no instability. BUT: degradation risk is real, resale dropping \u2014 eBay sold ~$305-380 used, ~$378-420 new. After fees expect ~$265-340. Platform is a dead end. \u26A0\uFE0F Arrow Lake Refresh reviews embargo lifts Mar 23, retail Mar 26. 290K Plus cancelled but 270K Plus ($299, 24 cores) directly undercuts 14900K resale. Sell BEFORE Mar 23 \u2014 reviews will remind buyers LGA1700 is dead. Expected $250-300 by summer.',
    ...
    },
    {
      ...
      perf4k: 95,
      tdp: 120,
      notes: '\u2B50 UNDISPUTED GAMING KING - 96MB 3D V-Cache, 30% faster than 14900K in gaming, runs cool at 120W. Amazon $430 (best price, near ATL!), Newegg $469, Best Buy $479. Free Crimson Desert game with purchase. 9850X3D ($499) launched but 9800X3D remains the value king at $40-69 less.',
      advice: 'BEST VALUE: $430 at Amazon (near ATL!), $469 at Newegg, $479 at Best Buy. After selling 14900K (~$305), net switch cost is ~$125 + mobo. AM5 platform lasts through 2027+ (Zen 6 & Zen 7 confirmed AM5). \u26A0\uFE0F Arrow Lake Refresh reviews Mar 23, retail Mar 26 \u2014 270K Plus ($299, 24 cores) won\'t beat 9800X3D in gaming but may trigger further price drops.',
      ...
      buyLinks: [
        { store: 'Amazon $430 + free Crimson Desert', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). $644 at Newegg w/ code ASF72 (verified active through Dec 2026). Best Buy/Micro Center ~$699. Amazon ~$675. Free Crimson Desert + MSI GK100 combo at Newegg.',
      advice: 'OVERKILL: Only 0.4% faster than 9800X3D in gaming for $214 more ($644 vs $430). No streaming planned, so the extra cores are wasted. Skip this.',
  ...
  gpu: [
    {
      ...
      perf4k: 72,
      tdp: 300,
      notes: '\u26A0\uFE0F SUPPLY-CONSTRAINED \u2014 ASUS EOL drama fully resolved (3 clarifications issued, card confirmed NOT discontinued) but production severely limited by GDDR7 shortage. NVIDIA cutting gaming GPU production 30-40% in H1 2026 \u2014 5070 Ti is FIRST target for cuts. Street price $970-1,000 typical, $859 deals now rare. Micro Center $750-1,010 (PNY at MSRP if in stock). ~54fps avg native 4K, DLSS 4 MFG boosts to 120-280fps.',
      advice: 'AVOID: At $970-1,000 street price, it overlaps with the 5080\'s $999 MSRP \u2014 and the 5080 is 15-18% faster at 4K. $859 deals now rare. If you find one at $750 (Micro Center PNY MSRP), decent value \u2014 but stock is nearly impossible. Tariffs + GDDR7 shortage keeping prices elevated through 2026. First in line for NVIDIA production cuts. Get the 5080 instead.',
    ...
    },
    {
      ...
      perf4k: 90,
      tdp: 360,
      notes: '\u2B50 SWEET SPOT FOR 4K@160Hz - DLSS 4 MFG turns 68fps native into 238fps in Cyberpunk. MSRP $999 \u2014 select AIBs (MSI Shadow 3X OC, Zotac Solid Core) still $999 on Newegg. Most AIBs $1,249-1,599. Amazon floor ~$1,249 (Zotac Solid Core). FE at $999 rare. \u26A0\uFE0F Tariffs + GDDR7 shortage = 15% avg price increase across RTX 50-series. Free Resident Evil Requiem with purchase (ends Mar 30!).',
      advice: 'RECOMMENDED: Best realistic path to 160Hz@4K. Select AIBs at $999 MSRP on Newegg (Zotac Solid Core, MSI Shadow 3X OC). Amazon floor ~$1,249. \u26A0\uFE0F DLSS 4.5 Dynamic MFG 6x launches March 31 via NVIDIA App beta \u2014 generates 5 extra frames per real frame (up from 4x), auto-adapts to your 160Hz monitor. Up to 35% higher 4K fps in path-traced titles. \u26A0\uFE0F Resident Evil Requiem bundle ends Mar 30 \u2014 act fast.',
    ...
    },
    {
      ...
      perf4k: 99,
      tdp: 575,
      notes: '\uD83D\uDC8E ABSOLUTE FASTEST GPU - 30-69% faster than 5080. 32GB GDDR7. Street price $2,910-$5,495 (1.5-2.75x MSRP $1,999). Premium AIBs exceeding $5,000 as TrendForce predicted. GDDR7 shortage structural \u2014 NVIDIA confirmed supply constraints through fiscal 2027. Newegg floor ~$2,910 (ASUS TUF), typical $3,300-3,500. FE ~$3,240. Amazon 3P ~$4,199. FE at $1,999 only via NVIDIA Verified Priority program.',
      advice: 'OVERKILL: ~150fps native 4K avg. At $3,400+ street, you\'re paying 3.4x the 5080 for 30-60% more perf. The 5080 with DLSS 4 MFG hits the same 160Hz target for 1/4 the price. MSRP ($1,999) is unobtainable through normal retail. Premium AIBs have hit $5,495+ as predicted. \u26A0\uFE0F Amazon listings are 3P sellers at $4,199+. Only buy from authorized sources.',
  ...
  motherboard: [
    {
      ...
      socket: 'LGA1700',
      recommended: false,
      notes: 'Solid Z790 for Intel - 16+1+1 VRM with 90A stages, WiFi 7, handles even LN2 overclocking. \u26A0\uFE0F Best Buy ~$360, Newegg 3P ~$330+. Limited stock as LGA1700 winds down.',
    ...
    },
    {
      ...
      advice: 'RECOMMENDED: $240 at Amazon. AM5 with WiFi 7 + 5GbE + upgrade path through 2027+ (Zen 6 & Zen 7 confirmed AM5). The 9800X3D doesn\'t need a $500 board. $120 less than Z790 Tomahawk ($360) AND has a platform future.',
      sources: [
  ...
  ram: [
    {
      ...
      capacity: 32,
      recommended: true,
      notes: '\u2B50 BEST VALUE - AMD EXPO certified. DDR5-6000 is the AM5 sweet spot (1:1 Infinity Fabric). Newegg $450 (code MMSF2448 saves $30, expires 3/15!). Amazon ~$472. \u26A0\uFE0F DDR5 prices 300-500% above pre-crisis levels due to AI demand \u2014 Samsung DDR5 contract prices up 178%. Shortage lasts through Q4 2027. Buy now \u2014 prices still climbing.',
      advice: '32GB is all you need for gaming (AAA uses ~20GB max). CL36 vs CL30 is ~1-2% gaming difference. Newegg $450 ($420 w/ code MMSF2448, expires 3/15!), Amazon $472. Prices still climbing month over month \u2014 buy sooner rather than later.',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg $450 (code: MMSF2448, exp 3/15)', url: 'https://www.newegg.com/g-skill-32gb-288-pin-ddr5-sdram/p/N82E16820374415' },
    ...
    },
    {
      ...
      capacity: 32,
      recommended: false,
      notes: 'Tighter CL30 timings for ~1-2% more gaming perf. AMD EXPO + Intel XMP 3.0 certified. Price volatile during DDR5 shortage \u2014 Amazon ~$518, Newegg ~$581. Code MMSF2444 status unverified \u2014 may have expired 3/15.',
      advice: 'PREMIUM TIMINGS: CL30 is technically optimal but ~$68 more than CL36 ($518 vs $450) for 1-2% real-world difference. That $68 is better spent elsewhere.',
      sources: [
        { label: 'PC Gamer: Best RAM 2026', url: 'https://www.pcgamer.com/best-ram-for-gaming/' },
    ...
    },
    {
      ...
      advice: 'OVERKILL FOR GAMING: Games use ~20GB max. You\'re paying $627 extra over 32GB ($1,077 vs $450) for capacity you\'ll never touch in games. Over $1,000 for RAM alone is brutal for any gaming build.',
      sources: [
  ...
  cooling: [
    {
      ...
      type: 'air',
      recommended: false,
      notes: 'Updated V2 of GN\'s "The Champ" air cooler. ~$40 on Amazon (deals occasionally hit $32-33). Dual-tower, 6 heatpipes, AGHP Gen 5.0, rated to 265W TDP. Supports LGA 1851/1700 and AM5.',
    ...
    },
    {
      ...
      type: 'aio',
      recommended: true,
      notes: '\u2B50 GN "The New Best" AIO - 2C cooler than standard on AMD, 10C on Intel. Integrated VRM fan. Nothing else comes close. Amazon ~$89 (non-RGB). ARGB variant ~$93-145. Price dropped significantly from $111.',
      advice: 'RECOMMENDED: $89 for the best AIO ever tested. Handles both 14900K and 9800X3D with ease. At this price, there\'s zero reason to consider anything else. $71 cheaper than the Corsair Titan for better thermals.',
      sources: [
      ...
      buyLinks: [
        { store: 'Amazon ~$89', url: 'https://www.amazon.com/Parent-ARCTIC-Liquid-Freezer-III/dp/B0F2TRHJX3' },
    ...
    },
    {
      ...
      advice: 'LUXURY: $160 at Micro Center ($191 elsewhere) for similar performance to the $89 Arctic (1.8-2.1x the price). Buy for the iCUE ecosystem and looks, not for thermals.',
      sources: [
  ...
  storage: [
    ...
    },
    {
      ...
      price: 690,
      recommended: false,
      notes: 'Single-sided 4TB. Premium for capacity. \u26A0\uFE0F Extreme price volatility \u2014 hit $1,600 in Feb 2026. Currently ~$690-715 via 3P sellers (Newegg 3P $690, CamelCamelCamel ~$715). Amazon direct OUT OF STOCK. NAND shortage hitting high-capacity drives hardest.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW: 990 Pro Review', url: 'https://www.tomshardware.com/reviews/samsung-990-pro-ssd-review' }
      ],
      buyLinks: [
        { store: 'Newegg 3P ~$690', url: 'https://www.newegg.com/samsung-4tb-990-pro-nvme-2-0/p/N82E16820147879' },
        { store: 'Amazon 3P ~$690-715', url: 'https://www.amazon.com/s?k=samsung+990+pro+4tb' }
      ]
    }
  ],
  case: [
  ...
  psu: [
    {
      ...
      wattage: 850,
      recommended: false,
      notes: 'ATX 3.1 (2025 refresh), native 12V-2x6, PCIe 5.1, 7yr warranty. ~$125 at Newegg/Micro Center, Amazon may have deals to $100. Good for 9800X3D + 5080.',
      advice: '',
      sources: [
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'Titanium efficiency (95.2%), virtually silent, 10yr warranty. Newegg ~$240 (27% off from $330). Amazon ~$250.',
      advice: '',
      sources: [
