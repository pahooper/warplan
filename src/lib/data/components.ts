...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⚠ Amazon ~$439 May 28 (REVERTED — UP $20 from $419.99 May 27 1-day Memorial Day match; Amazon-direct intermittently OOS, 3P fills in)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: '⚠ Newegg-direct $459 May 28 (LIFTED — UP $19 from $439.99 May 17-27 base; QC WebFetch direct on PDP confirms; SSF6798 -$20 code GONE; free Corsair CX750M PSU bundle GONE; Windows Central marked the deal [EXPIRED]; 1P sold/shipped by Newegg, limit 1)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⚠ Newegg-direct $699 May 28 (LIFTED — UP $84 from $614.99 May 25-27 floor; QC WebFetch on PDP confirms; $25 code GONE post-Memorial Day; free Cooler Master Elite 240mm AIO STILL bundled; sold/shipped by Newegg, limit 1)', url: 'https://www.newegg.com/amd-ryzen-9-9000-series-ryzen-9-9950x3d-granite-ridge-socket-am5-desktop-cpu-processor/p/N82E16819113884' }
      ]
    }
  ],
  gpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⭐⭐⭐ $999 MSRP STILL OPEN Day 2 May 28 — PNY OC $999.99 Amazon / MSI Shadow 3X OC $999 Newegg / ZOTAC Solid Core $999 Newegg / ASUS Prime SFF $999.99 (Amazon Prime). Already outlasted May 6/14 windows; buy TODAY', url: 'https://www.amazon.com/s?k=rtx+5080' },
        { store: '⭐⭐ Amazon ZOTAC SOLID CORE OC $1,249.99 holds May 28 (was $1,299 May 25 → $1,249.99 May 26-28; PC Guide-confirmed; non-MSRP fallback)', url: 'https://www.amazon.com/s?k=rtx+5080' },
        { store: '⭐ Newegg non-MSRP 1P May 28: ZOTAC SOLID CORE OC $1,379 holds (above the MSRP-SFF tier)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
