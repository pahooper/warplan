...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      perf4k: 95,
      tdp: 120,
      notes: '\u2B50 UNDISPUTED GAMING KING - 96MB 3D V-Cache, 30% faster than 14900K in gaming, runs cool at 120W. \u2B50 ALL-TIME LOW HIT APR 11: Amazon $409.95 (beat prior $419.95 by $10! \u26A0\uFE0F 1P OOS 5 days and counting \u2014 list now $464, 3P new ~$405-462), Micro Center $399 in-store ($379.99 w/ Insider card!), Newegg ~$479 + free MSI MAG Coreliquid 240mm AIO cooler + free Crimson Desert game!, Best Buy ~$449-479. Free Crimson Desert game ($69.99 value, launched Mar 19! Bundle thru Apr 25 \u2014 7 days left! Redeem by May 23). 9850X3D ($499 MSRP, ~$489-519) only 3-7% faster \u2014 9800X3D remains the value king. Arrow Lake Refresh (270K Plus $299 MSRP, ~$329-357 street) launched Mar 26 to rave reviews but X3D still dominates gaming by 10-20%. AMD responding with price cuts \u2014 PCGamesN: "AMD CPU price cuts have already begun." \u26A0\uFE0F Intel/AMD confirmed 10-15% CPU price hikes effective now (AI supply crunch) \u2014 retail X3D prices have actually dropped below MSRP despite channel hikes. Buy before retail catches up. \u26A0\uFE0F 9950X3D2 Dual Edition launches Apr 22 ($899 MSRP) \u2014 just 4 days away \u2014 may temporarily depress 9800X3D street prices further.',
      advice: 'BEST VALUE: $409.95 at Amazon (all-time low from Apr 11 \u2014 but 1P OOS 5 days running, list now $464, 3P ~$405-462) or $399 at Micro Center in-store ($379.99 w/ Insider card!) + free Crimson Desert ($69.99 value, now playable! Bundle ends Apr 25 \u2014 7 days left!) = ~$340 effective cost online IF Amazon 1P restocks, ~$310 at MC w/ card. Newegg ~$479 + free 240mm AIO cooler + Crimson Desert! After selling 14900K (~$305-370 on eBay used, net ~$265-322), net switch cost is ~$17-144 + mobo. AM5 platform lasts through 2027+ (Zen 6 "Medusa" desktop delayed to 2027, AM5 confirmed). Arrow Lake Refresh 270K Plus ($299 MSRP, ~$329-357 street) reviews stellar but X3D still dominates gaming by 10-20%. \u26A0\uFE0F Amazon 1P has been OOS since Apr 13 \u2014 no 1P restock signal yet. 3P is your only Amazon path right now. If you need it today, Micro Center in-store is the call.',
      ...
      buyLinks: [
        { store: 'Amazon $409.95 (all-time low; 1P OOS 5 days, list $464; 3P ~$405-462) + Crimson Desert (7 days left)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). Micro Center $599 in-store (clearing stock ahead of 9950X3D2 \u2014 unconfirmed if still current). \u26A0\uFE0F Amazon $659-675 (1P OOS 5 days and counting, 3P sellers from ~$462). Newegg $699 (confirmed, sold by Newegg direct, limit 1) + free Crimson Desert ($69.99 value, 7 days left thru Apr 25, redeem by May 23). Best Buy ~$699. \u26A0\uFE0F 9950X3D2 "Dual Edition" (208MB cache, dual V-Cache, 16c/32t, 4.3/5.6 GHz, 200W TDP) LAUNCHING APR 22 \u2014 just 4 days away! AMD official MSRP $899 (29% above 9950X3D), 5-10% productivity uplift, gaming flat vs 9950X3D. VideoCardz flagged Amazon preorders listed at $999 (premium over MSRP \u2014 scalping pressure already). Will push 9950X3D prices down further.',
      advice: 'OVERKILL: Only 0.4% faster than 9800X3D in gaming for $250+ more ($659+ vs $409). No streaming planned, so the extra cores are wasted. MC $599 in-store if still available (clearing for 9950X3D2). \u26A0\uFE0F Amazon 1P OOS for 5 days now \u2014 3P from ~$462. Buy from Newegg $699 if you must. \u26A0\uFE0F WAIT 4 DAYS: 9950X3D2 "Dual Edition" (208MB cache!) drops Apr 22 at $899 MSRP (Amazon preorders already $999 per VideoCardz \u2014 expect supply crunch). Will push this chip\'s price down further. The 9800X3D at $409 ($399 MC) + the same free game is the smarter buy for pure gaming.',
      ...
      buyLinks: [
        ...
        { store: 'Amazon $659-675 (1P OOS 5 days, 3P from ~$462)', url: 'https://www.amazon.com/dp/B0DVZSG8D5' },
  ...
  gpu: [
    {
      ...
      buyLinks: [
        { store: 'Newegg ~$999 (MSI Ventus 3X OC / Zotac Solid OC, floor, confirmed Apr 18)', url: 'https://www.newegg.com/p/pl?d=rtx+5070+ti' },
        { store: 'Amazon ~$1,049 (confirmed Apr 18)', url: 'https://www.amazon.com/s?k=rtx+5070+ti' },
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Newegg ~$999 (MSI Shadow 3X OC / Zotac Solid Core, MSRP! confirmed Apr 18)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: 'Amazon ~$1,249 (confirmed Apr 18)', url: 'https://www.amazon.com/s?k=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$3,799 (confirmed Apr 18)', url: 'https://www.amazon.com/s?k=rtx+5090' },
  ...
  storage: [
    ...
    },
    {
      ...
      price: 478,
      recommended: false,
      notes: 'Best Gen4 SSD. 7,450 MB/s read. Was $133 \u2014 NAND shortage has nearly 4x the price. \u26A0\uFE0F PRICE CLIMBING AGAIN: Amazon was ~$478 Apr 16, Pangoly tracking now shows ~$512 current (up $34 in 2 days). Samsung.com $639.99. Newegg ~$493 (3P). \u2B50 Micro Center ~$280 in-store (huge savings if nearby!). Still ~3.6-3.8x the $133 mid-2025 low. Hit $844 high on Mar 31, 2026. NAND crisis deepening \u2014 Q1 2026 contract prices surged 55-60% QoQ. Volatile \u2014 verify at checkout, price direction is UP.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$478-512 (\u26A0\uFE0F climbing again \u2014 verify at checkout)', url: 'https://www.amazon.com/SAMSUNG-Internal-Expansion-MZ-V9P2T0B-AM/dp/B0BHJJ9Y77' },
