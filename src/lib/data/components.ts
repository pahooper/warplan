...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $439.99 standalone (1P, holds May 1 since Apr 30 drop from $464; 13% off $506.99 list)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
        { store: 'Newegg $454 + FREE MSI Coreliquid A13 360mm AIO (code: BFEFE36 in cart, ongoing combo since Nov 2025, live May 1 — net $344 if you needed an AIO)', url: 'https://www.newegg.com/p/pl?d=amd+ryzen+7+9800x3d' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $639.99 (8% off $699 MSRP, in stock 1P May 1, limit 1, free Corsair CX750M 750W PSU bundle ACTIVE)', url: 'https://www.newegg.com/amd-ryzen-9-9000-series-ryzen-9-9950x3d-granite-ridge-socket-am5-desktop-cpu-processor/p/N82E16819113884' }
      ]
    }
  ],
  gpu: [
  ...
  motherboard: [
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: true,
      notes: '\u2B50 SWEET SPOT AM5 - WiFi 7, 5GbE, PCIe 5.0 M.2, 8-layer server-grade PCB. The 9800X3D doesn\'t need more. Amazon ~$227 (Pangoly May 1, ATL $219.99 Apr 2, holds flat vs Apr 28-30). Newegg listing $239.99 May 1 (3P shipped by Newegg \u2014 holds since Apr 27 drop from $299.99; QC-verified at checkout May 1, NOT 1P direct). MSI Store still OUT OF STOCK May 1 (email-when-back notify only). Best Buy ~$254. Amazon at ~$227 remains the floor May 1.',
      advice: 'RECOMMENDED: ~$227 at Amazon (still the floor May 1) or Newegg listing $239.99 (3P shipped by Newegg, holds since Apr 27 drop from $299.99 Apr 26 \u2014 QC-verified at checkout May 1, not 1P direct). \u26A0\uFE0F Newegg jumped to $300 from tariffs in late April \u2014 partial reversal stuck so far. AM5 with WiFi 7 + 5GbE + upgrade path through 2027+ (Zen 6 "Medusa" desktop delayed to 2027, AM5 confirmed). The 9800X3D doesn\'t need a $500 board. Tariff-driven flux on both boards (Z790 $212-300, X870 ~$227-240) keeps the gap small, and the X870 has a platform future. \u26A0\uFE0F Amazon/MSI prices likely to follow Newegg\'s tariff increase soon. Buy now.',
      sources: [
      ...
      buyLinks: [
        { store: 'MSI Store OUT OF STOCK May 1', url: 'https://us-store.msi.com/MAG-X870-TOMAHAWK-WIFI' },
        { store: 'Amazon ~$227 (best! Pangoly May 1)', url: 'https://www.amazon.com/MSI-Tomahawk-Motherboard-Processors-Bluetooth/dp/B0DG3HK897' },
  ...
  storage: [
    {
      ...
      buyLinks: [
        { store: 'Amazon ~$200.99 (best! May 1, DOWN ~$14 vs Apr 30; Pangoly tracker)', url: 'https://www.amazon.com/Crucial-P310-2280-PCIe-Gen4/dp/B0DC8RVRBZ' },
