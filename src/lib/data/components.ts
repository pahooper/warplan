...
export const components: ComponentData = {
  cpu: [
    {
      ...
      advice: 'AT 4K: Only 1-5% behind 9800X3D because GPU is the bottleneck. Keeping it is valid IF your chip shows no instability. BUT: degradation risk is real, resale dropping fast \u2014 eBay sold ~$200-280 used. After fees (~13%) expect ~$174-244 net used. Platform is a dead end. \u26A0\uFE0F\u26A0\uFE0F SELL NOW: Arrow Lake Refresh launches Mar 26 to rave reviews. 270K Plus ($299, 24 cores) obliterates the value proposition of a used 14900K \u2014 why buy a degradation-risk chip for ~$250 when $299 gets you a brand new 270K Plus with Editor\'s Choice reviews? 250K Plus at $199 also available. Resale will crater once 270K Plus is widely available. Run stability benchmarks + screenshot results before listing (buyers are wary). Expected $175-225 by summer.',
    ...
    },
    {
      ...
      perf4k: 95,
      tdp: 120,
      notes: '\u2B50 UNDISPUTED GAMING KING - 96MB 3D V-Cache, 30% faster than 14900K in gaming, runs cool at 120W. Amazon ~$420 (all-time low! $60 off MSRP), Micro Center $399 in-store ($379.99 w/ Insider card!), Newegg ~$464, Best Buy ~$479. Free Crimson Desert game ($69.99 value, launched Mar 19! Bundle thru Apr 25, redeem by May 23). 9850X3D ($499 MSRP, ~$480-500) only 3-7% faster \u2014 9800X3D remains the value king. Arrow Lake Refresh (270K Plus $299) launches Mar 26 but X3D still dominates gaming.',
      advice: 'BEST VALUE: ~$420 at Amazon (all-time low! $60 off MSRP) or $399 at Micro Center in-store ($379.99 w/ Insider card!) + free Crimson Desert ($69.99 value, now playable!) = ~$350 effective cost online, ~$310 at MC w/ card. After selling 14900K (~$200-280 on eBay used, net ~$174-244), net switch cost is ~$106-176 + mobo. AM5 platform lasts through 2027+ (Zen 6 desktop delayed to 2027, AM5 confirmed). Arrow Lake Refresh launches Mar 26 \u2014 270K Plus ($299, 24 cores) reviews are stellar but X3D still dominates gaming by 10-20%. 270K Plus at $299 further crushes i9-14900K resale.',
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). Micro Center ~$599 in-store (best!). Amazon direct OOS \u2014 3P ~$675. Newegg ~$675 (code ASF72 confirmed active thru 12/31/26 = ~$640). Best Buy ~$699. Free Crimson Desert ($69.99 value, launched Mar 19! Bundle thru Apr 25, redeem by May 23). Newegg also bundling free accessories w/ purchase (bundle varies \u2014 check listing).',
      advice: 'OVERKILL: Only 0.4% faster than 9800X3D in gaming for $179-255 more ($599-675 vs $420). No streaming planned, so the extra cores are wasted. Newegg at $675 (code ASF72 confirmed working = $644). The 9800X3D at $420 ($399 MC) + the same free game is the smarter buy for pure gaming.',
  ...
  gpu: [
    {
      ...
      perf4k: 72,
      tdp: 300,
      notes: '\u26A0\uFE0F SUPPLY-CONSTRAINED \u2014 ASUS & MSI officially denied EOL claims but production severely limited by GDDR7 shortage. NVIDIA cutting gaming GPU production 30-40% in H1 2026 \u2014 5070 Ti is FIRST target for cuts. 50 SUPER lineup officially on hold \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028 (Tom\'s HW). Street price $900-1,070 new (typical). Newegg $999 floor (MSI VENTUS, ZOTAC SOLID); some bundling free MSI 750W PSU. Micro Center ~$999+ in-store. Amazon ~$1,069. ~54fps avg native 4K, DLSS 4 MFG boosts to 120-280fps. DLSS 4.5 Dynamic MFG 6x launches Mar 31 (6 days!).',
      advice: '\u26A0\uFE0F VALUE UPDATE: Street price trending down to $900-1,070. 5080 MSRP $999 models occasionally appear on Newegg (MSI Shadow 3X OC, Zotac Solid Core) \u2014 if you can grab a 5080 at $999, skip the 5070 Ti entirely (15-18% faster, same price). Only buy the 5070 Ti if 5080 at $999 is sold out and $1,249+ is too steep. DLSS 4.5 Dynamic MFG 6x (Mar 31) will boost both cards.',
    ...
    },
    {
      ...
      perf4k: 90,
      tdp: 360,
      notes: '\u2B50 SWEET SPOT FOR 4K@160Hz - DLSS 4 MFG turns 68fps native into 238fps in Cyberpunk. \u26A0\uFE0F $999 MSRP deals appear sporadically on Newegg (MSI Shadow 3X OC, Zotac Solid Core) but sell out fast. Typical street $1,249+ (Zotac Solid Core OC on Amazon). FE $999 restocks on Best Buy (sells out in minutes). Micro Center ~$1,099-1,300 in-store. \u26A0\uFE0F GDDR7 shortage + NVIDIA 30-40% production cuts. 50 SUPER officially on hold \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028. DLSS 4.5 Dynamic MFG 6x launches Mar 31 (6 days!) \u2014 6x frame gen, auto-adapts to your 160Hz target.',
      advice: 'RECOMMENDED: Best realistic path to 160Hz@4K. Typical street $1,249 (Zotac Solid Core OC on Amazon/Newegg). $999 MSRP deals appear sporadically on Newegg \u2014 set alerts for MSI Shadow 3X OC and Zotac Solid Core. Street peaked at $1,500 in Aug 2025, now trending down. At $1,249, still 15-18% faster than 5070 Ti ($999) for $250 more \u2014 worth it for native 4K headroom. DLSS 4.5 Dynamic MFG 6x launches Mar 31 (6 days!) \u2014 generates 5 extra frames per real frame, auto-adapts to your 160Hz monitor. 20+ new path-traced titles announced at GDC 2026. No SUPER refresh coming \u2014 this is the card to buy.',
      ...
      buyLinks: [
        ...
        { store: 'Micro Center ~$1,099-1,300 in-store', url: 'https://www.microcenter.com/search/search_results.aspx?Ntt=rtx+5080' }
      ]
    },
    {
      id: '5090',
      ...
      perf4k: 99,
      tdp: 575,
      notes: '\uD83D\uDC8E ABSOLUTE FASTEST GPU - 30-69% faster than 5080. 32GB GDDR7. Street price $2,910-$3,595 (1.46-1.80x MSRP $1,999). Premium/liquid-cooled AIBs $3,300-5,000+. GDDR7 shortage structural \u2014 NVIDIA confirmed supply constraints through fiscal 2027. ASUS TUF ~$2,910 (cheapest AIB, Newegg). Amazon ~$3,000-4,232. Best Buy FE $1,999 sells out in under 8 min. Micro Center ~$2,910+ in-store (limited). eBay used ~$1,583 (below MSRP!). No SUPER refresh coming \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028. \u26A0\uFE0F Prices predicted to RISE to $3,800-4,400 by Q4 2026.',
      advice: 'OVERKILL: ~150fps native 4K avg. ASUS TUF at ~$2,910 is cheapest AIB, but still 2.3x the 5080 ($1,249 street) for 30-60% more perf. The 5080 with DLSS 4 MFG hits the same 160Hz target for less than half the price. Used on eBay ~$1,583 if you absolutely must have one. \u26A0\uFE0F Prices predicted to RISE to $3,800-4,400 by Q4 2026.',
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$3,000-4,232', url: 'https://www.amazon.com/s?k=rtx+5090' },
  ...
  motherboard: [
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: false,
      notes: 'Budget AM5 - 14+2+1 VRM is plenty for 9800X3D. PCWorld: "leaves very little on the table". Amazon ~$191 (price dropped!), Micro Center ~$176 in-store (unverified \u2014 may vary), Best Buy ~$261.',
      advice: 'VALUE PICK: Amazon ~$191 is $49 less than X870 Tomahawk ($240 MSI Store). Loses WiFi 7 and PCIe 5.0 M.2. At $191 online, the $49 gap vs X870 Tomahawk ($240) makes the B650 a real value option again \u2014 but X870\'s WiFi 7 + 5GbE + PCIe 5.0 M.2 are arguably worth $49 more. Best at Micro Center in-store pricing (~$176).',
      sources: [
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$191', url: 'https://www.amazon.com/MSI-B650-Tomahawk-Motherboard-Processors/dp/B0BHCCNSRH' },
  ...
  ram: [
    {
      ...
      capacity: 32,
      recommended: true,
      notes: '\u2B50 BEST VALUE - AMD EXPO certified. DDR5-6000 is the AM5 sweet spot (1:1 Infinity Fabric). Amazon ~$454, Newegg ~$450. \u26A0\uFE0F Code MMSF256 appears EXPIRED \u2014 try code BGSF285 at checkout (may drop to ~$370). DDR5 prices still ~408% above pre-crisis levels due to AI demand \u2014 data centers consuming 70% of all memory chips. Micron exited consumer RAM entirely \u2014 only Samsung & SK Hynix remain. March 2026 saw first 7.2% decline after 6 months of growth \u2014 peak may be behind us but shortage expected through 2028.',
      advice: '32GB is all you need for gaming (AAA uses ~20GB max). CL36 vs CL30 is ~1-2% gaming difference. \u26A0\uFE0F Old code MMSF256 appears expired. Try Newegg code BGSF285 at checkout \u2014 may drop to ~$370. Without a code, Newegg ~$450 and Amazon ~$454 are similar. March showed first DDR5 price decline in 6 months \u2014 may be past the peak, but Micron leaving consumer RAM means supply stays tight.',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg ~$450 (try code BGSF285)', url: 'https://www.newegg.com/g-skill-flare-x5-32gb-ddr5-6000-cas-latency-cl36-desktop-memory-black/p/N82E16820374419' },
    ...
    },
    {
      ...
      capacity: 32,
      recommended: false,
      notes: 'Tighter CL30 timings for ~1-2% more gaming perf. AMD EXPO + Intel XMP 3.0 certified. Price volatile during DDR5 shortage \u2014 Amazon ~$462 (best! dropped from $697), MemoryC ~$605, Newegg ~$671. Amazon price improving fast.',
      advice: 'PREMIUM TIMINGS: CL30 is technically optimal but only ~$8-12 more than CL36 ($462 vs $450-454) for 1-2% real-world difference. At this gap, CL30 is actually worth considering. Amazon at $462 is now cheapest (was $697).',
      sources: [
        { label: 'PC Gamer: Best RAM 2026', url: 'https://www.pcgamer.com/best-ram-for-gaming/' },
    ...
    },
    {
      ...
      capacity: 64,
      recommended: false,
      notes: '\u26A0\uFE0F\u26A0\uFE0F SEVERE SHORTAGE - 64GB DDR5 now ~$950 at Newegg, ~$1,141 at Amazon (back in stock but expensive). Tom\'s HW: "64GB of DDR5 now costs more than an entire PS5." RAMageddon 2026 easing slightly \u2014 March saw first 7.2% decline. Still ~408% above pre-crisis levels. AI demand consuming all HBM/DRAM fab capacity. Shortage expected until Q4 2027 at earliest, some analysts say 2028.',
      advice: 'OVERKILL FOR GAMING: Games use ~20GB max. You\'re paying ~$496-687 extra over 32GB ($950-1,141 vs $454) for capacity you\'ll never touch in games. Price easing from peak ($1,077) but still ~$950 at Newegg. Amazon back in stock at $1,141 (not worth the $191 premium over Newegg).',
      sources: [
  ...
  cooling: [
    ...
    },
    {
      ...
      type: 'aio',
      recommended: true,
      notes: '\u2B50 GN "The New Best" AIO - 2C cooler than standard on AMD, 10C on Intel. Integrated VRM fan. Nothing else comes close. Amazon ~$105 (Non-RGB black, MSRP $124), ARGB ~$119. Tom\'s HW: "Best AIO for 9950X3D and Intel too." Tech4Gamers: "Cooler To Beat In 2026."',
      advice: 'RECOMMENDED: ~$105 on Amazon for the non-RGB black variant of the best AIO ever tested. ARGB variant ~$119 if you want lighting. Handles both 14900K and 9800X3D with ease. $86 cheaper than the Corsair Titan ($191) for better thermals.',
      sources: [
  ...
  storage: [
    ...
    },
    {
      ...
      price: 710,
      recommended: false,
      notes: 'Single-sided 4TB. Premium for capacity. \u26A0\uFE0F Extreme price volatility \u2014 hit $1,600 in Feb 2026. Currently ~$710 (Newegg 3P, best!), Newegg direct $800, ~$723 Amazon. Was $250 in Nov 2023. 30-day low $690 \u2014 occasional dips below $700 still happen. Still ~2.5x the mid-2025 low.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW: 990 Pro Review', url: 'https://www.tomshardware.com/reviews/samsung-990-pro-ssd-review' }
      ],
      buyLinks: [
        { store: 'Newegg ~$710 (3P)', url: 'https://www.newegg.com/samsung-4tb-990-pro-nvme-2-0/p/N82E16820147879' },
  ...
  case: [
    ...
    },
    {
      ...
      price: 124,
      recommended: false,
      notes: 'Stunning wood+mesh design. Great airflow despite aesthetic focus. Newegg ~$124 (price drop! was $155), B&H ~$126, Amazon ~$155.',
      advice: '',
      sources: [
  ...
  psu: [
    {
      ...
      wattage: 850,
      recommended: false,
      notes: 'ATX 3.1 (2025 refresh), native 12V-2x6, PCIe 5.1, 7yr warranty. B&H ~$125 (best!), Amazon ~$133, Newegg ~$145 (code SUSF66 for extra discount), Best Buy ~$145. Good for 9800X3D + 5080.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg ~$134 (code SUSF66)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-850-w-cybenetics-gold-power-supply-black-rm850e/p/N82E16817139336' },
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'ATX 3.1, 1000W Gold, compact 140mm. Headroom for any GPU. Newegg ~$170 (best! dropped $5), B&H ~$175, Amazon ~$177, Best Buy ~$190 (price increased).',
      advice: '',
      sources: [
        { label: 'Tom\'s HW', url: 'https://www.tomshardware.com/pc-components/power-supplies/corsair-rm1000e-atx-3-1-power-supply-review' }
      ],
      buyLinks: [
        { store: 'Newegg ~$170 (best!)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-1000-w-cybenetics-gold-power-supply-black-rm1000e/p/N82E16817139337' },
    ...
    },
    {
      ...
      wattage: 1000,
      recommended: false,
      notes: 'Titanium efficiency (95.2%), virtually silent, 10yr warranty. Newegg ~$235 (28% off $330 MSRP!), Amazon ~$249. ATX 3.0 compliant (not 3.1 like Corsair units).',
      advice: '',
      sources: [
