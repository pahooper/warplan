...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      perf4k: 95,
      tdp: 120,
      notes: '\u2B50 UNDISPUTED GAMING KING - 96MB 3D V-Cache, 30% faster than 14900K in gaming, runs cool at 120W. \u2B50 ALL-TIME LOW HIT APR 11: Amazon $409.95 (beat prior $419.95 by $10! \u26A0\uFE0F 1P OOS 6 days and counting \u2014 list now $464, 3P new ~$389-462 incl. used from $389.99), Micro Center $399 standalone ($379.99 w/ Insider card!) or $679.99 bundle w/ B850 + 32GB DDR5 (per VideoCardz Apr 15), Newegg $959.99 bundle (CPU+mobo+RAM+SSD+Crimson Desert) or standalone + free Crimson Desert, Best Buy ~$449-479. Free Crimson Desert game ($69.99 value, launched Mar 19! Bundle thru Apr 25 \u2014 6 days left! Redeem by May 23). 9850X3D launched Jan 29 at $499 MSRP, only 3-7% faster \u2014 9800X3D remains the value king. Arrow Lake Refresh (270K Plus $299 MSRP, ~$329-349 street \u2014 17-19% over MSRP per Tom\'s HW) launched Mar 26 to rave reviews but X3D still dominates gaming by 10-20%. AMD responding with price cuts \u2014 PCGamesN: "AMD CPU price cuts have already begun." \u26A0\uFE0F Intel/AMD confirmed 10-15% CPU price hikes effective now (AI supply crunch); Intel reportedly planning a THIRD hike in May (tech4gamers) \u2014 retail X3D prices have actually dropped below MSRP despite channel hikes. Buy before retail catches up. \u26A0\uFE0F 9950X3D2 Dual Edition launches Apr 22 ($899 MSRP) \u2014 just 3 days away \u2014 may temporarily depress 9800X3D street prices further.',
      advice: 'BEST VALUE: $409.95 at Amazon (all-time low from Apr 11 \u2014 but 1P OOS 6 days running, list now $464, 3P ~$389-462 incl used at $389.99) or $399 at Micro Center in-store ($379.99 w/ Insider card!) + free Crimson Desert ($69.99 value, now playable! Bundle ends Apr 25 \u2014 6 days left!) = ~$340 effective cost online IF Amazon 1P restocks, ~$310 at MC w/ card. Micro Center bundle $679.99 (CPU+B850+32GB DDR5) = fantastic value if you\'re near a store. Newegg $959.99 bundle (CPU+mobo+RAM+SSD+Crimson Desert). After selling 14900K (~$250-305 on eBay used, net ~$217-265 \u2014 resale floor dropped ~$55 in 2 weeks), net switch cost is ~$95-190 + mobo. AM5 platform lasts through 2027+ (Zen 6 "Medusa" desktop delayed to 2027, AM5 confirmed). Arrow Lake Refresh 270K Plus ($299 MSRP, ~$329-349 street) reviews stellar but X3D still dominates gaming by 10-20%. \u26A0\uFE0F Amazon 1P has been OOS since Apr 13 \u2014 no 1P restock signal yet. 3P is your only Amazon path right now. If you need it today, Micro Center in-store is the call.',
      ...
      buyLinks: [
        { store: 'Amazon $409.95 all-time low; 1P OOS 6 days, list $464; 3P $389-462 + Crimson Desert (6 days left)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). Micro Center $599 in-store (clearing stock ahead of 9950X3D2 \u2014 unconfirmed if still current). \u26A0\uFE0F Amazon ~$675 (1P confirmed Apr 19, 3P sellers from ~$462). Newegg $699 (confirmed, sold by Newegg direct, limit 1) + free Crimson Desert ($69.99 value, 6 days left thru Apr 25, redeem by May 23). Best Buy ~$699. \u26A0\uFE0F 9950X3D2 "Dual Edition" (208MB cache, dual V-Cache, 16c/32t, 4.3/5.6 GHz, 200W TDP) LAUNCHING APR 22 \u2014 just 3 days away! AMD official MSRP $899 (29% above 9950X3D), 5-10% productivity uplift, gaming flat vs 9950X3D. VideoCardz flagged Amazon preorders listed at $999 (premium over MSRP \u2014 scalping pressure already); B&H listed at $899 MSRP (no pre-order premium). Newegg "coming soon." Will push 9950X3D prices down further post-launch.',
      advice: 'OVERKILL: Only 0.4% faster than 9800X3D in gaming for $250+ more ($675+ vs $409). No streaming planned, so the extra cores are wasted. MC $599 in-store if still available (clearing for 9950X3D2). Buy from Newegg $699 if you must. \u26A0\uFE0F WAIT 3 DAYS: 9950X3D2 "Dual Edition" (208MB cache!) drops Apr 22 at $899 MSRP (Amazon preorders $999, B&H $899 \u2014 buy B&H to avoid scalp premium). Will push this chip\'s price down further. The 9800X3D at $409 ($399 MC) + the same free game is the smarter buy for pure gaming.',
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$675 (1P in stock Apr 19, 3P from ~$462)', url: 'https://www.amazon.com/dp/B0DVZSG8D5' },
  ...
  gpu: [
    {
      ...
      buyLinks: [
        { store: 'Newegg ~$999 (MSI Ventus 3X OC / Zotac Solid OC, floor, confirmed Apr 19)', url: 'https://www.newegg.com/p/pl?d=rtx+5070+ti' },
        { store: 'Amazon ~$1,049 (confirmed Apr 19)', url: 'https://www.amazon.com/s?k=rtx+5070+ti' },
    ...
    },
    {
      ...
      buyLinks: [
        { store: 'Newegg ~$999 (MSI Shadow 3X OC / Zotac Solid Core, MSRP! confirmed Apr 19)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: 'Amazon ~$1,249 (confirmed Apr 19)', url: 'https://www.amazon.com/s?k=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Amazon ~$3,799 (confirmed Apr 19)', url: 'https://www.amazon.com/s?k=rtx+5090' },
  ...
  motherboard: [
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: false,
      notes: 'Premium AM5 - 5x M.2 (3x PCIe 5.0), WiFi 7, 5GbE, USB4. Best-in-class. \uD83D\uDC8E Amazon ~$362 (price stabilized, pre-tariff). Newegg $394.99 (17% off $477, down from $409.99 \u2014 new low!). \u26A0\uFE0F Best Buy jumped to $418.99 (up from $435, then broke LOWER \u2014 mixed signals, likely tariff-adjusted). ASUS eShop $500 MSRP. \u26A0\uFE0F Price stabilized from $699 spike in Feb 2026 but 32% Taiwan tariff pressure building. \u2B50 ASUS $30 Steam code promo CONFIRMED ACTIVE April 2026 (covers Strix X870E-E/H plus many others \u2014 per Tweaktown Apr coverage; no updated end-date confirmed beyond prior July 1).',
      advice: 'PREMIUM: ~$362 at Amazon (28% off $500 MSRP!) \u2014 grab before tariff hits here too. Newegg $394.99. Best Buy $418.99 (tariff-hit). $30 ASUS Steam code only via ASUS eShop ($500) = ~$470 effective vs ~$362 Amazon. Buy from Amazon. Still $122 more than X870 Tomahawk ($240 pre-tariff / $300 Newegg post-tariff) for USB4, 5x M.2, premium VRMs. Hard to justify for a 9800X3D gaming build, but a solid price for this board right now.',
      sources: [
  ...
  ram: [
    {
      ...
      capacity: 32,
      recommended: true,
      notes: '\u2B50 BEST VALUE - AMD EXPO certified. DDR5-6000 is the AM5 sweet spot (1:1 Infinity Fabric). Amazon ~$359 (confirmed Apr 19, best flat price! Pangoly-tracked). \u2B50 Newegg $449.99 list \u2014 code STRF99 drops $90 to $359.99 (verified active Apr 19). \u26A0\uFE0F Old code SSF5478 appears EXPIRED \u2014 absent from all coupon aggregators (Discoup, SimplyCodes, CouponFollow, Tom\'s HW) as of Apr 19. TrendForce Mar 31: DDR5 retail fell 7.2% MoM in March \u2014 FIRST monthly decline in 8 months. But still 408% above Jul 2025 baseline. Samsung+SK Hynix negotiating Q2 contract hikes of 58-63% QoQ. Shortage expected through late 2027/2028 (PC Gamer). Micron exited consumer RAM \u2014 only Samsung & SK Hynix remain. Google TurboQuant AI memory compression cited as easing some data-center demand pressure.',
  ...
  cooling: [
    {
      ...
      type: 'air',
      recommended: false,
      notes: 'Updated V2 of GN\'s "The Champ" air cooler. Amazon ~$33 (confirmed Apr 19, PC Gamer-cited stable price). Newegg SE V2 $45.90 on sale (list $49.90, confirmed Apr 19). Dual-tower, 6 heatpipes, AGHP Gen 5.0, rated to 265W TDP. Supports LGA 1851/1700 and AM5.',
  ...
  case: [
    ...
    },
    {
      ...
      price: 103,
      recommended: false,
      notes: 'Proven airflow champ. 160mm fans, 392mm GPU clearance. \u2B50 Newegg $102.99 + $10 promotional gift card bonus (confirmed Apr 19, limit 2/customer \u2014 effective net ~$93). Best Buy ~$103. \u26A0\uFE0F Amazon prior $167 spike unable to re-verify, listings active but dynamic pricing \u2014 default to Newegg for the gift card promo anyway.',
      advice: '',
      sources: [
    ...
    },
    {
      ...
      price: 124,
      recommended: false,
      notes: '\u2B50 Stunning wood+mesh design. Great airflow despite aesthetic focus. \u2B50 NEW LOW: Newegg $123.99 (20% off $154.99, Best Seller, in stock limit 5, confirmed Apr 19). Amazon prior $171 unable to re-verify. B&H prior $119 unable to re-verify (403 anti-scrape). Was $124 during Amazon Big Spring sale in March \u2014 Newegg matches that now. \u26A0\uFE0F Tariff risk: Section 301 tariffs on Chinese electronics delayed until Nov 10, 2026 \u2014 prices stable for now but expect hikes in H2.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW Review', url: 'https://www.tomshardware.com/reviews/fractal-design-north' }
      ],
      buyLinks: [
        { store: 'Newegg $123.99 (20% off $155, new low!)', url: 'https://www.newegg.com/fractal-design-atx-mid-tower-steel-case-charcoal-black-fd-c-nor1c-01/p/N82E16811352203' },
  ...
  psu: [
    {
      ...
      wattage: 850,
      recommended: false,
      notes: 'ATX 3.1 (2025 refresh), native 12V-2x6, PCIe 5.1, 7yr warranty. Newegg $124.98 (13% off $144.99, confirmed Apr 19 \u2014 the $94.99 deal from a week ago has NOT returned, Newegg still at $124.98). Amazon ~$125. Best Buy ~$125. PCPartPicker lowest alt listing $109.99. Good for 9800X3D + 5080. \u26A0\uFE0F China PSU tariff stack: 45% base rate already in effect + distributors raised 6-10% in Jan \u2014 expect further hikes in H2 2026. Watch Newegg for the $94.99 deal to return.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        { store: 'Newegg $124.98 (13% off, prior $94.99 deal expired)', url: 'https://www.newegg.com/corsair-rmx-series-atx-3-1-compatible-850-w-cybenetics-gold-power-supply-black-rm850e/p/N82E16817139336' },
