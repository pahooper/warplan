...
export const components: ComponentData = {
  ...
  gpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '\u26a0\ufe0f Newegg cheapest May 11 LIFTED to GIGABYTE WindForce SFF $1,399 1P (UP $100 from May 10 PNY ARGB OC $1,299.99 \u2014 PNY ARGB OC also lifted/displaced per bestvaluegpu May 11; the May 10 inversion to Newegg\'s favor FLIPPED BACK to Amazon\'s favor in 24 hrs; \u26a0\ufe0f PRAGMATA bundle on select cards ENDED May 12 (codes still redeemable through June 9 if you bought a qualifying card before midnight May 12) \u2014 expires TODAY, NVIDIA terms confirm via WebSearch May 12; codes redeemable on Steam through June 9 if you grab a qualifying card before midnight)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
