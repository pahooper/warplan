...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⭐⭐ Amazon $419.99 May 27 (NEW LOW — DOWN $20 from $439.99 10-day hold; VideoCardz confirms; matches Newegg net but no free PSU bundle)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: '⭐⭐ Newegg-direct $419.99 May 27 ($439.99 base - $20 with code SSF6798 + FREE Corsair CX750M 750W PSU ~$59-65 value; CONFIRMED ACTIVE via VideoCardz/DigitalCitizen/WCCFtech/HotHardware post-Memorial Day; 10+ day hold; 1P sold/shipped by Newegg, limit 1; BETTER than Amazon thanks to free PSU)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
    ...
    },
    {
      ...
      perf4k: 96,
      tdp: 170,
      notes: '16 cores / 128MB cache - Ties 9800X3D in gaming but adds massive productivity power. Full overclocking support (first for X3D Ryzen 9). Micro Center $599 in-store (clearing stock ahead of 9950X3D2 \u2014 unconfirmed if still current Apr 26). \u26A0\uFE0F Amazon ALL-TIME LOW $573.99 EXPIRED — reverted to $639.99 by May 14 (the $573.99 Apr 26-May 10 window has closed; CamelCamelCamel/Tom\'s HW; was live since Apr 26— Tom\'s HW May 9 still flags as topping Amazon best-sellers, 14 days continuous) (Amazon Gaming Week, 18% off $699 MSRP, $125 cut per Tom\'s HW + Windows Central + Club386 + VideoCardz; topped Amazon best-sellers list. Limited-time deal, stock flipped between in/OOS during window). ⭐⭐ Newegg-direct DROPPED to ~$614.99 May 25: $639.99 list - $25 limited-time code + FREE Cooler Master Elite 240mm AIO bundled (PC Guide "best price in 30 days"). ⚠️ AIO downgrade alert: bundle cooler changed from MSI MAG Coreliquid A13 360mm (May 16) → Cooler Master Elite 240mm — same free-AIO concept but smaller radiator. Sold/shipped by Newegg, limit 1. Amazon $669 May 27 (DOWN $30 from $700 list, per VideoCardz; was ~$659 May 25; slightly up from $639.99 May 17 floor but bundle-free path). 3P alts $699-730 if needed sooner. Best Buy ~$699. ⚠️ Crimson Desert promo bundle ENDED Apr 25 — no longer a factor. \u26A0\uFE0F 9950X3D2 "Dual Edition" (208MB cache, dual V-Cache, 16c/32t, 4.3/5.6 GHz, 200W TDP) LAUNCHED APR 22 at $899 MSRP \u2014 TechSpot/Tom\'s HW/Phoronix/KitGuru reviews confirm only 0.8% gaming uplift over 9800X3D, 6-9% productivity gain (Blender +7%, LLVM +6.6%). Notebookcheck verdict: "questions its existence" for gamers. Both Amazon and Newegg now listing 9950X3D2 at $899 MSRP \u2014 no scalp premium post-launch (initial Amazon $999 preorder normalized). This pressures 9950X3D demand from above (better productivity) and below (9800X3D Amazon $409.95 NEW ATL May 11 matches it in gaming for $164 less even at the $574 Amazon floor).',
      advice: 'OVERKILL: Only 0.4-0.8% faster than 9800X3D in gaming for ~$195-250 more ($614.99 Newegg w/code or $669 Amazon vs $419.99 9800X3D Amazon/Newegg May 27). No streaming planned, so the extra cores are wasted. ⭐ Newegg-direct ~$614.99 holds May 27 (PC Guide "best price in 30 days": $639.99 list - $25 limited-time code + FREE Cooler Master Elite 240mm AIO; 1P, limit 1). Amazon $669 May 27 (DOWN $30 from $699 list per VideoCardz; was $659 May 25 → $669 today, slightly up). MC $599 in-store if available. \u26A0\uFE0F 9950X3D2 LAUNCHED Apr 22 at $899 MSRP and reviewers confirmed it adds only 0.8% over the 9800X3D in gaming \u2014 the whole high-end X3D stack just collapsed for pure gamers. The 9800X3D at ~$419.99 Amazon/Newegg / $399 MC is the smarter buy. Only consider 9950X3D if you do heavy productivity (Blender, LLVM compile); don\'t pay $615-669 for a 0.4-0.8% gaming gain.',
  ...
  gpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⭐⭐⭐ $999 MSRP REOPENED May 27 — PNY OC $999.99 Amazon / MSI Shadow 3X OC $999 Newegg / ZOTAC Solid Core $999 Newegg / ASUS Prime SFF $999.99 (Amazon Prime). Flash event, buy TODAY', url: 'https://www.amazon.com/s?k=rtx+5080' },
        { store: '⭐⭐ Amazon ZOTAC SOLID CORE OC $1,249.99 holds May 27 (was $1,299 May 25 → $1,249.99 May 26; PC Guide-confirmed; non-MSRP fallback)', url: 'https://www.amazon.com/s?k=rtx+5080' },
        { store: '⭐ Newegg non-MSRP 1P May 27: ZOTAC SOLID CORE OC $1,379 holds (above the MSRP-SFF tier)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⚠️ Newegg-direct 5090 1P floor UNCERTAIN May 25 — prior nightly\'s "$3,999 lift" UNVERIFIED at QC; aggregators peg floor $3,658-$3,799; Newegg 5090 listings increasingly 3P marketplace, verify 1P at checkout', url: 'https://www.newegg.com/p/pl?d=rtx+5090' },
  ...
  motherboard: [
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: true,
      notes: '\u2B50 SWEET SPOT AM5 - WiFi 7, 5GbE, PCIe 5.0 M.2, 8-layer server-grade PCB. The 9800X3D doesn\'t need more. \u2B50 Newegg 1P-direct $229.99 sale holds May 25 (QC WebFetch on Newegg PDP confirms live: list $239.99 - $10 off = $229.99 sale, sold/shipped by Newegg, limit 5, free 30-day returns; the research agent\'s "Newegg LIFTED to $299.99 / $279.99 sale" claim DID NOT MATERIALIZE \u2014 QC reverted). Best Buy $239.99 holds May 25 (marked from $259.99). Amazon $226.99 historical floor listed but not freshly scraped this cycle \u2014 historically the floor at $219.99-226.99; verify at checkout. Pangoly: ATL $219.99 Apr 2, broad May floor at $229.99 still holds. \u26a0\ufe0f BROADER CONTEXT: TrendForce Q2 DRAM +63% QoQ; ASUS/MSI/Gigabyte/ASRock cutting 2026 mobo shipments 24-37% (VideoCardz/Gizmochina); MSI signaling 15-30% price raises industry-wide \u2014 upward pressure building but X870 Tomahawk has HELD the $229.99 Newegg 1P floor through this week. \u26a0\ufe0f TARIFF CORRECTION: the 32% Taiwan IEEPA tariff was STRUCK DOWN by the Supreme Court Feb 2026 and replaced with a 10% Section 122 tariff (PC Gamer, tariffstool.com); Section 122 expires ~July 24, 2026 \u2014 but the AI-supply-driven shipment cut is now the dominant upward force. MSI Store still OUT OF STOCK May 25.',
      advice: 'RECOMMENDED: \u2b50 Newegg 1P-direct $229.99 sale May 26 (QC WebFetch-verified live on Newegg PDP: list $239.99 - $10 off, sold/shipped by Newegg, limit 5, free 30-day returns; floor holds 12+ days from May 14) is the cheapest 1P. Best Buy $239.99 (marked from $259.99) is the backup 1P. Amazon $226.99 historical floor listed live but May 25 not freshly scraped \u2014 historically the floor at $219.99-226.99, verify before relying on it. \u26A0\uFE0F The research agent\'s "Newegg LIFTED to $299.99 / $279.99 sale" hike claim was FALSE \u2014 QC reverted; the $229.99 Newegg 1P floor still holds. AM5 with WiFi 7 + 5GbE + upgrade path through 2027+ (Zen 6 "Medusa" desktop delayed to 2027, AM5 confirmed). The 9800X3D doesn\'t need a $500 board. \u26A0\uFE0F Shipment cuts (24-37% per VideoCardz/Gizmochina) + memory crisis remain upward forces; a real hike could still arrive \u2014 buy soon if you\'re close to building.',
      sources: [
    ...
    },
    {
      ...
      advice: 'VALUE BACK ONLINE: \u2b50 Best Buy $159.99 May 25 (NEW \u2014 matches Walmart $159.99, marked from $219.99) AND Walmart $159.99 still live \u2014 two 1P paths at $159.99 now. ~$70 below X870 Tomahawk ($229.99 Newegg / $239.99 Best Buy May 25) \u2014 the budget gap is the same as last week; X870 floor held at Newegg despite Best Buy +$10 bump. Amazon still ~$259 (stale tariff/dynamic-price inflated \u2014 ignore). Micro Center ~$176 in-store. Even with the wider gap, the X870\'s WiFi 7 + 5GbE + PCIe 5.0 M.2 + AM5 platform future are worth ~$80 on a long-lived 4K build \u2014 buy B650 only if every dollar counts.',
      sources: [
      ...
      buyLinks: [
        ...
        { store: '⭐ Walmart $159.99 May 25 (holds vs May 17)', url: 'https://www.walmart.com/search?q=msi+mag+b650+tomahawk+wifi' },
        { store: '⭐ Best Buy $159.99 May 25 (NEW — marked from $219.99, matches Walmart)', url: 'https://www.bestbuy.com/product/msi-mag-b650-tomahawk-wifi-socket-am5-amd-b650-atx-ddr5-wi-fi-6e-motherboard-black/J3P7TXG8HS' },
    ...
    },
    {
      ...
      socket: 'AM5',
      recommended: false,
      notes: 'Premium AM5 - 5x M.2 (3x PCIe 5.0), WiFi 7, 5GbE, USB4. Best-in-class. \uD83D\uDC8E Newegg-direct $399.99 1P May 27 (QC-verified, DOWN $10 from $409.99 May 17-26 — Newegg deepened the discount from "7% off $443.99" to "9% off $443.99 / $44 savings"; sold/shipped by Newegg, limit 2/customer, free 30-day returns; second-best 1P this month after $393.99 May 8). 3P marketplace alts antonline $502 / NothingButSavings $512 sit well above Newegg-direct. Amazon $419 still listed but Newegg now the cheapest authorized channel. \u26A0\uFE0F Best Buy ~$419 (tariff-volatile). ASUS eShop $500 MSRP. \u26A0\uFE0F Price stabilized from $699 spike in Feb 2026 but 32% Taiwan tariff pressure building. \u2B50 ASUS $30 Steam code promo last CONFIRMED active Mar 11 2026 (Tweaktown; covers Strix X870E-E/H + others) \u2014 UNCONFIRMED past mid-April, "limited-time" with no verified end-date; verify on ASUS eShop before counting on it.',
      advice: 'PREMIUM: Newegg-direct $399.99 May 27 (DOWN $10 from $409.99 May 17-26; discount deepened to 9% off $443.99 / $44 savings; sold/shipped by Newegg, limit 2/customer). Beats Amazon $419 by $19. ⚠️ Pangoly composite SOFTENED to ~$369 May 25 (DOWN from $409.99 May 17 — verify which retailer; possibly transient 3P, not yet confirmed at a major 1P channel). Newegg-direct May 17 floor was $409.99; CompSource $470.59 May 12. Pangoly $369 best May 25 (unverified at any major retailer \u2014 treat as transient 3P, not the buyable price. Best Buy ~$419 ties Amazon. $30 ASUS Steam code only via ASUS eShop ($500) = ~$470 effective, still not worth it. ~$180 more than X870 Tomahawk ($229.99 Newegg 1P May 25) for USB4, 5x M.2, premium VRMs. Hard to justify for a 9800X3D gaming build \u2014 buy if you actually need USB4 + 5x M.2.',
      sources: [
      ...
      buyLinks: [
        ...
        { store: '⭐ Newegg-direct $399.99 May 27 (1P, DOWN $10 from $409.99 May 17-26 floor; discount widened to 9% off $443.99 / $44 savings; sold/shipped by Newegg, limit 2/customer, free 30-day returns)', url: 'https://www.newegg.com/asus-rog-strix-x870e-e-gaming-wifi-atx-motherboard-amd-x870e-am5/p/N82E16813119682' },
  ...
  cooling: [
    ...
    },
    {
      ...
      advice: 'LUXURY: ⭐ Corsair.com weekly-deal status UNCONFIRMED May 25 (research surfaced $239.99 MSRP without the prior $159.99 sale — verify on Corsair.com before counting on it; ~$159.99 first-party Best Seller historically \u2014 verify price on page; beats Amazon ~$190.99). Gap to Arctic stays ~$107 (Arctic at $83.99 NEW LOW May 25). Newegg-direct still OOS. Still buy for iCUE/aesthetics, not thermals.',
      sources: [
  ...
  storage: [
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '\u2b50\u2b50\u2b50 Amazon Memorial Day $389.99 May 27 (39% off $639 list \u2014 Gizmodo/TechRadar/WCCFTech/Kotaku/PCGuide/WePC corroborate; cheapest 990 Pro 2TB in months, DOWN ~$40 from May 25 baseline; likely holiday-bound, snapback expected)', url: 'https://www.amazon.com/SAMSUNG-Internal-Expansion-MZ-V9P2T0B-AM/dp/B0BHJJ9Y77' },
