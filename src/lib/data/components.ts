...
export const components: ComponentData = {
  cpu: [
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⚠️ Amazon ~$439.99 May 17 (the $409.95 May 11 1-day ATL and $419.99 May 13 print both gone; now matching Walmart $439.99-from-$479.99 — VideoCardz/Windows Central; Amazon-direct flips OOS, 3P fills in; free Crimson Desert bundle still listed)', url: 'https://www.amazon.com/AMD-9800X3D-16-Thread-Desktop-Processor/dp/B0DKFMSMYK' },
        { store: '⭐⭐ Newegg-direct ~$439.99 base May 17 — code SSF6798 CONFIRMED EXPIRED (Windows Central now [EXPIRED]-tagged, bundle ended 05/14; the $419.99 + free Corsair CX750M PSU + Gamdias cooler + McAfee bundle is GONE, no replacement code in PC Gamer/Tom\'s Guide/TechRadar trackers May 17; 1P sold/shipped by Newegg, limit 1)', url: 'https://www.newegg.com/amd-ryzen-7-9000-series-ryzen-7-9800x3d-granite-ridge-zen-5-socket-am5-120w-desktop-cpu-processor/p/N82E16819113877' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⚠️ Amazon $639.99 May 17 (LIFTED from $573.99 May 10 ATL; CamelCamelCamel + WebSearch May 17 confirm $639.99 1P, range low $629 Apr 18 / high $1082.78 Apr 24; 8% off $699 MSRP, stock varies)', url: 'https://www.amazon.com/dp/B0DVZSG8D5' },
        { store: 'Newegg-direct $639.99 May 17 (8% off $699 MSRP, in stock 1P, limit 1; bundle now a free MSI MAG Coreliquid A13 360mm AIO per Tom\'s HW, not the earlier Corsair PSU — verify at checkout)', url: 'https://www.newegg.com/amd-ryzen-9-9000-series-ryzen-9-9950x3d-granite-ridge-socket-am5-desktop-cpu-processor/p/N82E16819113884' }
      ]
    }
  ],
  gpu: [
    {
      ...
      perf4k: 72,
      tdp: 300,
      notes: '\u26A0\uFE0F QUASI-EOL \u2014 ASUS told retailers production ended, then denied it; NVIDIA says "not EOL" but GDDR7 shortage has effectively halted restocking. NVIDIA cutting gaming GPU production 30-40% in H1 2026 \u2014 5070 Ti is FIRST target for cuts. 50 SUPER lineup indefinitely delayed (confirmed CES 2026) \u2014 no new NVIDIA gaming GPUs in 2026; RTX 60-series pushed to 2028 (Tom\'s HW). \u2b50\u2b50 FLOOR HOLDS May 17 - ASUS PRIME RTX 5070 Ti 16G STILL OOS at Newegg-direct (1P listing still shows $899.99 marked-down from $953.99 list with PRAGMATA bundle, but stock depleted since May 7 - 3P sellers SenyTech Global $1,229.99 cheapest, range to $1,339 are the in-stock options on the listing — bestvaluegpu confirms OOS 10+ days). bestvaluegpu + Newegg listing scrape pegs Newegg cheapest May 17 as MSI Ventus 3X PZ OC BLACK $979 (PRAGMATA, "lowest in 30 days", flat May 10-17 — 7+ day hold) — STAYS the 1P floor with PRIME OOS. Next 1P tier: MSI Shadow 3X OC $989.99 (PRAGMATA), Gigabyte WindForce $999.99 ($100 off), MSI Ventus 3X OC BLACK $999.99 (all 1P, in stock). Mid-tier $1,019-1,159 (PNY ARGB, Gigabyte AERO OC). Amazon ASUS PRIME OC $999 May 17 per bestvaluegpu (cheapest authorized PRIME 1P now that Newegg PRIME is OOS, flat May 10-17 — Newegg MSI Ventus $979.99 still ~$20 cheaper for in-stock 1P). ASUS publicly DENIED EOL claim Apr 2026 (Tom\'s HW) but confirmed memory supply impacted production \u2014 supply tight but not collapsing. Micro Center average $930 across locations (one MSRP card at $899 \u2014 see VideoCardz). Best Buy ~$1,069-1,299. \u26a0\ufe0f eBay used floor SLID to ~$799 May 17 (bestvaluegpu, DOWN from ~$870-878 \u2014 used 5070 Ti supply loosening as new-card panic eases). Peaked at $1,220 in mid-2025. ~54fps avg native 4K, DLSS 4.5 Dynamic MFG 6x live (596.21/596.36 WHQL drivers; 596.36 added Conan Exiles Enhanced May 5) \u2014 auto-targets 160Hz, 6x mode for path-traced titles. \u2b50 PRAGMATA bundle ENDED May 12 (ran Apr 14 - May 12 on select 5070 Ti / 5080 / 5090; codes still redeemable through June 9 if you bought a qualifying card before midnight May 12 — no longer a buying lever for May 13+ purchases) \u2014 \u26a0\ufe0f ENDED May 12 (ran Apr 14 - May 12; codes still redeemable on Steam through June 9 if you bought a qualifying card before midnight May 12 — no longer a lever for May 13+ buys). Stock depleting \u2014 new units may not be replenished.',
      advice: 'BUDGET PICK MAY 17: no $999 5080 MSRP window confirmed open May 16-17 (the May 14 reopen slammed shut <24h; Tom\'s HW $999 articles still recirculating are the stale May 14 / Sept 2025 ones — bestvaluegpu May 17 shows NO MSRP 5080) — current authorized 5080 floor is $1,299 Amazon PNY ARGB EPIC-X (6-day hold May 11-17), so the 5070 Ti keeps its value-pick role. The 5070 Ti is 15-18% slower than the 5080 but $320 cheaper at current pricing. ASUS PRIME 16G $899.99 Newegg-direct STILL OOS 10+ days in (1P listing shows $899.99 list with PRAGMATA bundle but stock depleted since May 7; 3P SenyTech Global $1,229.99 cheapest, range to $1,339). Cheapest 1P in-stock 5070 Ti is MSI Ventus 3X PZ OC BLACK at $979 Newegg (PRAGMATA, "lowest in 30 days", flat May 10-17 — 7+ day hold per bestvaluegpu). Amazon ASUS PRIME OC $999 per bestvaluegpu May 17 (cheapest Amazon authorized 1P). ⚠️ eBay used floor SLID to ~$799 (bestvaluegpu May 17, DOWN from ~$875-878 May 16 — ~$180 below new, warranty risk now buys a real discount as used 5070 Ti supply loosens). ⭐ RTX 5060 Ti (16GB, $429) is the budget alternative if 4K@160Hz isn\'t a hard target. ⚠️ Buy plan: 5070 Ti $979 Newegg if you\'re OK with DLSS-dependent 160Hz; step to 5080 $1,299 Amazon for native 4K@160Hz margin. If a $999 5080 SFF flashes back to Newegg, drop everything and grab it. ⚠️ PRAGMATA bundle ENDED May 12 (codes redeemable on Steam through June 9 for qualifying May 12 buys — no lever for May 16+).',
      ...
      buyLinks: [
        ...
        { store: '⭐ Newegg-direct $979 MSI Ventus 3X PZ OC BLACK (1P in stock May 17, flat May 10-17, PRAGMATA, "lowest in 30 days") — STAYS the cheapest 1P option after PRIME OOS', url: 'https://www.newegg.com/p/pl?d=rtx+5070+ti' },
        ...
        { store: 'Amazon ASUS PRIME OC $999 May 17 per bestvaluegpu (Newegg PRIME OOS so this is the cheapest authorized PRIME 1P in stock; Newegg MSI Ventus $979.99 still ~$20 cheaper for in-stock 5070 Ti)', url: 'https://www.amazon.com/s?k=rtx+5070+ti' },
    ...
    },
    {
      ...
      buyLinks: [
        { store: '⚠️ Newegg cheapest 1P May 17: GIGABYTE WindForce SFF $1,399 (held since May 11 — 6-day hold per bestvaluegpu; the May 14 $999 MSI Shadow 3X OC + ZOTAC Solid Core SFF MSRP window survived <24 hours)', url: 'https://www.newegg.com/p/pl?d=rtx+5080' },
        { store: '⭐ Amazon PNY ARGB EPIC-X $1,299 holds May 17 (6-day hold from May 11 per bestvaluegpu/gpudeals.net — cheapest authorized 1P; no $999 MSRP SKU confirmed open May 16-17)', url: 'https://www.amazon.com/s?k=rtx+5080' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Newegg-direct $3,799 ZOTAC SOLID OC White + GIGABYTE Gaming OC $3,799.99 1P (desktop floor HOLDS May 17, flat since May 5 lift; ZOTAC SOLID OC Black sold out / "Coming Soon")', url: 'https://www.newegg.com/p/pl?d=rtx+5090' },
        { store: 'Newegg ASUS TUF: 3P only $4,199-5,099 (1P still GONE May 17 — 19 days since Apr 28)', url: 'https://www.newegg.com/asus-tuf-gaming-tuf-rtx5090-32g-gaming-geforce-rtx-5090-32gb-graphics-card-triple-fans/p/N82E16814126752' },
        { store: 'Amazon ~$3,899 (ASUS ROG Astral OC, bestvaluegpu May 17, flat since May 2 — 15-day hold)', url: 'https://www.amazon.com/s?k=rtx+5090' },
        { store: 'B&H Photo $3,799.95 MSI Suprim Liquid SOC', url: 'https://www.bhphotovideo.com/c/search?q=rtx+5090' },
        { store: '⚠️ eBay used ~$3,700 floor May 17 (GPUPoet May 2026 lowest-avg ~$3,657 + bestvaluegpu $3,700; 30-day sold avg $4,039.50 across 207 units; trajectory Apr 30 $3,580 → May 11 $3,500 → May 15-17 $3,700, scalper-exhaustion arc stalled; only ~$99 below Newegg 1P $3,799 now)', url: 'https://www.ebay.com/sch/i.html?_nkw=rtx+5090&_sop=12' },
  ...
  motherboard: [
    {
      ...
      advice: 'FOR i9-14900K: \u26A0\uFE0F Amazon jumped to ~$298 from $212 (tariff pass-through) \u2014 no longer the budget win it was. Newegg 3P $304.28 holds May 17 (HK seller "HeLiXing", was $346 Apr 29; B.Y.R alt $313) \u2014 tariff pass-through partially reversing. At $298 Amazon it\'s virtually identical to X870 Tomahawk ($227 Amazon, the AM5 board with a real platform future). Only buy if you\'re definitely keeping the 14900K. If tariff pricing hits both boards equally, AM5\'s platform future through 2027+ makes X870 the no-brainer.',
      sources: [
    ...
    },
    {
      ...
      advice: 'VALUE BACK ONLINE: Walmart $159.99 May 17 (down from $198.52, unchanged this cycle) is ~$67 below X870 Tomahawk ($227 Amazon) \u2014 a real budget gap, IF the Walmart listing is legit (verify at checkout; possibly volatile/3P). Amazon still ~$259 (tariff-inflated \u2014 ignore). Micro Center ~$176 in-store also undercuts X870. Even so, the X870\'s WiFi 7 + 5GbE + PCIe 5.0 M.2 + AM5 platform future are worth ~$50-70 on a long-lived 4K build \u2014 buy B650 only if every dollar counts.',
      sources: [
    ...
    },
    {
      ...
      advice: 'PREMIUM: Newegg-direct ~$409.99 May 17 (UP $16 from the $393.99 May 8 floor that held 12 days; Newegg also cut LIST from $500 → $443.99, so the "21% off" framing collapsed to "7% off / $34 savings") still undercuts Amazon $419 by ~$9. Pangoly composite still shows ~$393.99 best May 17 (unverified at any major retailer \u2014 treat as transient 3P, not the buyable price. Best Buy ~$419 ties Amazon. $30 ASUS Steam code only via ASUS eShop ($500) = ~$470 effective, still not worth it. $183 more than X870 Tomahawk ($227 Amazon) for USB4, 5x M.2, premium VRMs. Hard to justify for a 9800X3D gaming build \u2014 buy if you actually need USB4 + 5x M.2.',
      sources: [
  ...
  cooling: [
    {
      ...
      type: 'air',
      recommended: false,
      notes: 'Updated V2 of GN\'s "The Champ" air cooler. Amazon ~$33 holds May 17 (WebSearch confirms $33 Amazon US, flat since the May 6 reversal from $40 May 5 \u2014 long-stable at the Apr 21 floor; Tom\'s HW cites a $36 alt listing). Newegg SE V2 $49.90 (Thermalright Authorized Store, top-rated, holds since Apr 28 \u2014 list price now matches sale). Dual-tower, 6 heatpipes, AGHP Gen 5.0, rated to 265W TDP. Supports LGA 1851/1700 and AM5.',
      advice: 'BUDGET: ⭐ Amazon ~$33 holds May 17 (WebSearch-confirmed, flat since the May 6 reversal from $40 — long-stable at the Apr 21 floor). Absurd deal for 9800X3D (120W). Beats $80-100 towers at half the price. Newegg V2 $49.90 if Amazon out. NOT enough for i9-14900K under sustained 253W load.',
      sources: [
      ...
      buyLinks: [
        { store: 'Amazon ~$33 holds May 17 (WebSearch-confirmed, flat since the May 6 reversal from $40 May 5; long-stable at the Apr 21 floor)', url: 'https://www.amazon.com/Thermalright-Peerless-Assassin-120-Cooler/dp/B0DP23NF7T' },
    ...
    },
    {
      ...
      type: 'aio',
      recommended: true,
      notes: '\u2B50 GN "The New Best" AIO - 2C cooler than standard on AMD, 10C on Intel. Integrated VRM fan. Nothing else comes close. Amazon Non-RGB Black $89 ATL ACTIVE May 17 \u2014 Tom\'s HW Memorial Day deal article confirms "lowest-ever price" (non-RGB $89, the prior $105 listing dropped back to the ATL). ARGB Black $91.49 May 17 (Tom\'s HW "lowest-ever" Memorial Day \u2014 HIGH confidence, still live). ⚠️ Newegg first-party listing GONE Apr 30 — only 3P TELeasy at $165.99 / B-IN $169.99 (red flag — Amazon is the only sane path). Tom\'s HW: "Best AIO for 9950X3D and Intel too." Tech4Gamers: "Cooler To Beat In 2026."',
      advice: 'RECOMMENDED: $89 Amazon non-RGB Black ATL May 17 (Tom\'s HW Memorial Day "lowest-ever price", still live) for the best AIO ever tested. ARGB Black $91.49 if you want lighting (also "lowest-ever" per Tom\'s HW). Handles both 14900K and 9800X3D with ease. ~$102 cheaper than the Corsair Titan ($191) for better thermals.',
      sources: [
      ...
      buyLinks: [
        { store: '\u2b50 Amazon $89 Non-RGB Black ATL May 17 (Tom\'s HW Memorial Day "lowest-ever"; ARGB Black $91.49) \u2014 Newegg 1P gone Apr 30, Amazon is the path', url: 'https://www.amazon.com/Parent-ARCTIC-Liquid-Freezer-III/dp/B0F2TRHJX3' },
    ...
    },
    {
      ...
      advice: 'LUXURY: ⭐ Corsair.com weekly-deal page still live May 17 (~$159.99 first-party Best Seller, free ship \u2014 verify price on page; beats Amazon ~$190.99). Gap to Arctic stays ~$71 (Arctic at $89 ATL). Newegg-direct still OOS. Still buy for iCUE/aesthetics, not thermals.',
      sources: [
  ...
  storage: [
    {
      ...
      buyLinks: [
        { store: 'Amazon ~$290 holds May 17 (Pangoly confirms sustained since the May 6 jump from $245; high $649.98 Mar 21; verify at checkout)', url: 'https://www.amazon.com/Crucial-P310-2280-PCIe-Gen4/dp/B0DC8RVRBZ' },
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: 'Pangoly composite ~$430 May 17 (flat vs May 13; ~$400 in gaming-SSD comparisons; excludes Amazon, authorized-retailer composite \u2014 verify at checkout)', url: 'https://www.amazon.com/SAMSUNG-Internal-Expansion-MZ-V9P2T0B-AM/dp/B0BHJJ9Y77' },
    ...
    },
    {
      ...
      price: 899,
      recommended: false,
      notes: 'Single-sided 4TB. Premium for capacity. \u2B50 PRICE HOLDS HIGH May 17: Pangoly composite tracker ~$899 (flat vs the May 16 lift from $799.99 May 13 — NAND squeeze sustained; Pangoly excludes Amazon, authorized-retailer composite; Apr 22 spike-print hit $2,199 from 3P gougers). ⚠️ Newegg 3P floor LIFTED May 10: ServerQue $849 GONE (was the floor since Apr 28 \u2014 11+ day hold). New floor EvoMicro $929.99 / BioStar $929.95 / The Best Deals For You $939.99 / MobileMonster $940.00 (3P-only, Newegg-direct not stocked) \u2014 net $80 floor jump in ~2 days, NAND squeeze biting. 30-day avg $725 per pricehistory.app stale \u2014 May 10 is solidly above that. Hit $1,600 in Feb 2026. Was $250 in Nov 2023. Still ~3x the mid-2025 low. NAND crisis continues \u2014 Q1 2026 contract prices surged 55-60% QoQ, TrendForce forecasts Q2 +70-75% QoQ; Samsung reportedly halting SATA SSD production (Tweaktown) \u2014 no relief until late 2027. Price volatile, trending UP \u2014 check at purchase time.',
      advice: '',
      sources: [
        { label: 'Tom\'s HW: 990 Pro Review', url: 'https://www.tomshardware.com/reviews/samsung-990-pro-ssd-review' }
      ],
      buyLinks: [
        { store: 'Pangoly composite ~$899 May 16 (⚠️ ~$899 May 17, flat vs the May 16 lift from $799.99 May 13; 3P Newegg floor ~$930 \u2014 verify at checkout)', url: 'https://www.amazon.com/s?k=samsung+990+pro+4tb' },
        { store: 'Newegg 3P floor ~$929.99 May 17 (EvoMicro $929.99 / BioStar $929.95 / MobileMonster $940; Newegg-direct not stocked; ServerQue $849 floor long gone)', url: 'https://www.newegg.com/samsung-4tb-990-pro-nvme-2-0/p/N82E16820147879' }
      ]
    }
  ],
  case: [
    {
      ...
      price: 85,
      recommended: true,
      notes: '\u2B50 Includes 3 fans! Great airflow, clean cable management, InfiniRail fan mounting. GN: "Corsair Remembered How to Make a Case." \u26A0\uFE0F SALE HOLDS May 17! Newegg $84.99 1P direct Black holds May 17 (26% off list $114.99 \u2014 long-stable, the reliable buy). \u2b50\u2b50 WHITE $59.99 STILL AROUND May 17: Slickdeals May 5 staff post had the Amazon WHITE non-ARGB at $59.99 (CC-9011313-WW); as of May 17 B&H ALSO lists the 4000D RS White at $59.99 free ship WITH a free ASUS ROG Orion headset \u2014 a fresh, cleaner path than the volatile Amazon Slickdeals listing. Either is the cheapest 4000D RS in years (~$25 below Newegg Black, ~47% below list) \u2014 verify at checkout, deals flip in hours. Corsair.com Wood RS variant $129.99 (different SKU, the standard 4000D RS RS-fan version is back to ~$99.99-114.99 list across retailers). ARGB variant ~$125. Amazon dynamic pricing on Black variant. \u26A0\uFE0F Earlier $57.86/$70.04 Amazon 30% coupon (Apr 18 Slickdeals YMMV) long expired. Watch Slickdeals for sale return \u2014 Corsair has run this case at $84.99 multiple times in 2026.',
      advice: '',
      sources: [
      ...
      buyLinks: [
        ...
        { store: '⭐⭐ B&H WHITE $59.99 May 17 (free ship + free ASUS ROG Orion headset — cleaner path than the volatile Amazon Slickdeals listing; cheapest 4000D RS in years, ~$25 below Newegg Black, ~47% below list)', url: 'https://www.bhphotovideo.com/c/search?q=corsair+frame+4000d+rs+white' },
        { store: '⭐⭐ Amazon WHITE non-ARGB $59.99 — Slickdeals staff post May 5 (CC-9011313-WW); status May 17 volatile/UNVERIFIED, B&H $59.99 is the steadier path — verify before relying on it', url: 'https://www.amazon.com/CORSAIR-4000D-Modular-Airflow-Mid-Tower/dp/B0DPJ9FD5N' },
    ...
    },
    {
      ...
      price: 103,
      recommended: false,
      notes: 'Proven airflow champ. 160mm fans, 392mm GPU clearance. \u2B50 Best Buy $102.99 confirmed May 17 (HIGH confidence, 216RX Black ARGB). Newegg $102.99 + $10 gift card promo last confirmed Apr 21 — STILL UNVERIFIED May 17, treat as possibly lapsed (effective net ~$93 IF still live). \u26A0\uFE0F Amazon prior $167 spike unable to re-verify, listings active but dynamic pricing \u2014 Newegg best with gift card, otherwise Newegg/Best Buy tied at $102.99.',
      advice: '',
      sources: [
  ...
  psu: [
    ...
    },
    {
      ...
      buyLinks: [
        ...
        { store: '⭐ Best Buy ~$148 black May 17 (marked down from $189.99 — MED confidence, verify; white $174.99)', url: 'https://www.bestbuy.com/site/searchpage.jsp?st=corsair+rm1000e' },
